...
load Controls_aud_HighPer_Hits_ERP_ST_bc;
load Tinnitus_aud_HighPer_Hits_ERP_ST_bc;

Controls_aud_HighPer_Hits_ERP_sub_avg = [];
Tinnitus_aud_HighPer_Hits_ERP_sub_avg = [];
%Controls_aud_HighPer_Hits_ERP_sub_var = [];
%Tinnitus_aud_HighPer_Hits_ERP_sub_var = [];

for i = 1 : 4
    Controls_aud_HighPer_Hits_ERP_sub_avg(:,:,i) = reshape(Controls_aud_HighPer_Hits_ERP_ST_bc(i).subject.avg,20,900);
    %Controls_aud_HighPer_Hits_ERP_sub_var(:,:,i) = reshape(var(Controls_aud_10_CR_ERP_ST_bc(Controls_sub(i)).subject.trial,0,1),20,900);
end


for i = 1 : 3
    Tinnitus_aud_HighPer_Hits_ERP_sub_avg(:,:,i) = reshape(Tinnitus_aud_HighPer_Hits_ERP_ST_bc(i).subject.avg,20,900);
    %Tinnitus_aud_HighPer_Hits_ERP_sub_var(:,:,i) = reshape(var(Tinnitus_aud_10_CR_ERP_ST_bc(Tinnitus_sub(i)).subject.trial,0,1),20,900);
end

Controls_aud_HighPer_Hits_ERP_avg = mean(Controls_aud_HighPer_Hits_ERP_sub_avg,3);
%Controls_pooledSD = sqrt(mean(Controls_aud_HighPer_Hits_ERP_sub_var,3)./1857);
%Controls_aud_HighPer_Hits_ERP_pooledSE = Controls_pooledSD.*sqrt(4/1857);

Tinnitus_aud_HighPer_Hits_ERP_avg = mean(Tinnitus_aud_HighPer_Hits_ERP_sub_avg,3);
%Tinnitus_pooledSD = sqrt(mean(Tinnitus_aud_HighPer_Hits_ERP_sub_var,3)./1636);
%Tinnitus_aud_HighPer_Hits_ERP_pooledSE = Tinnitus_pooledSD.*sqrt(4/1636);

Tin_Con_aud_HighPer_Hits_ERP_avg = Tinnitus_aud_HighPer_Hits_ERP_avg - Controls_aud_HighPer_Hits_ERP_avg;

customcolormap = customcolormap_preset('red-white-blue');

% during stimulus potential - 

% Controls_aud_HighPer_FA_meanAmp_LPP_2 = mean(Controls_aud_HighPer_Hits_ERP_avg(1:19,197:216),2);
% Tinnitus_aud_HighPer_FA_meanAmp_LPP_2 = mean(Tinnitus_aud_HighPer_Hits_ERP_avg(1:19,197:216),2);
% 
% TinCon_aud_HighPer_FA_meanAmp_LPP_2 = Tinnitus_aud_HighPer_FA_meanAmp_LPP_2 - Controls_aud_HighPer_FA_meanAmp_LPP_2;
% 
% figure; topoplot(Controls_aud_HighPer_FA_meanAmp_LPP_2, ALLEEG.chanlocs, 'maplimits', 'maxmin', 'style', 'both', 'shading', 'interp'); colormap(customcolormap);
% figure; topoplot(Tinnitus_aud_HighPer_FA_meanAmp_LPP_2, ALLEEG.chanlocs, 'maplimits', 'maxmin', 'style', 'both', 'shading', 'interp'); colormap(customcolormap);
% figure; topoplot(TinCon_aud_HighPer_FA_meanAmp_LPP_2, ALLEEG.chanlocs, 'maplimits', 'maxmin', 'style', 'both', 'shading', 'interp'); colormap(customcolormap);

Controls_aud_HighPer_Hits_ERP_3chan = Controls_aud_HighPer_Hits_ERP_avg([5 10 15],:);
Tinnitus_aud_HighPer_Hits_ERP_3chan = Tinnitus_aud_HighPer_Hits_ERP_avg([5 10 15],:);

%% Plotting - Low Perceivers: Hits: Tin vs Con

load Controls_aud_LowPer_Hits_ERP_ST_bc;
load Tinnitus_aud_LowPer_Hits_ERP_ST_bc;

Controls_aud_LowPer_Hits_ERP_sub_avg = [];
Tinnitus_aud_LowPer_Hits_ERP_sub_avg = [];
%Controls_aud_LowPer_Hits_ERP_sub_var = [];
%Tinnitus_aud_LowPer_Hits_ERP_sub_var = [];

for i = 1 : 4
    Controls_aud_LowPer_Hits_ERP_sub_avg(:,:,i) = reshape(Controls_aud_LowPer_Hits_ERP_ST_bc(i).subject.avg,20,900);
    %Controls_aud_LowPer_Hits_ERP_sub_var(:,:,i) = reshape(Controls_aud_LowPer_Hits_ERP_ST_bc(i).subject.avg,20,900);
end

for i = 1 : 5
    Tinnitus_aud_LowPer_Hits_ERP_sub_avg(:,:,i) = reshape(Tinnitus_aud_LowPer_Hits_ERP_ST_bc(i).subject.avg,20,900);
    %Tinnitus_aud_LowPer_Hits_ERP_sub_var(:,:,i) = reshape(Controls_aud_LowPer_Hits_ERP_ST_bc(i).subject.avg,20,900);
end

Controls_aud_LowPer_Hits_ERP_avg = mean(Controls_aud_LowPer_Hits_ERP_sub_avg,3);
% Controls_pooledSD = sqrt(mean(Controls_aud_LowPer_Hits_ERP_sub_var,3)./1857);
% Controls_aud_LowPer_Hits_ERP_pooledSE = Controls_pooledSD.*sqrt(10/1857);

Tinnitus_aud_LowPer_Hits_ERP_avg = mean(Tinnitus_aud_LowPer_Hits_ERP_sub_avg,3);
% Tinnitus_pooledSD = sqrt(mean(Tinnitus_aud_LowPer_Hits_ERP_sub_var,3)./1636);
% Tinnitus_aud_LowPer_Hits_ERP_pooledSE = Tinnitus_pooledSD.*sqrt(11/1636);

Tin_Con_aud_LowPer_Hits_ERP_avg = Tinnitus_aud_LowPer_Hits_ERP_avg - Controls_aud_LowPer_Hits_ERP_avg;

customcolormap = customcolormap_preset('red-white-blue');

% during stimulus - 756 to 812

Controls_aud_LowPer_Hits_meanAmp_LPP_2 = mean(Controls_aud_LowPer_Hits_ERP_avg(1:19,215:229),2);
Tinnitus_aud_LowPer_Hits_meanAmp_LPP_2 = mean(Tinnitus_aud_LowPer_Hits_ERP_avg(1:19,215:229),2);

TinCon_aud_LowPer_Hits_meanAmp_LPP_2 = Tinnitus_aud_LowPer_Hits_meanAmp_LPP_2 - Controls_aud_LowPer_Hits_meanAmp_LPP_2;

figure; topoplot(Controls_aud_LowPer_Hits_meanAmp_LPP_2, ALLEEG.chanlocs, 'maplimits', 'maxmin', 'style', 'both', 'shading', 'interp'); colormap(customcolormap);
figure; topoplot(Tinnitus_aud_LowPer_Hits_meanAmp_LPP_2, ALLEEG.chanlocs, 'maplimits', 'maxmin', 'style', 'both', 'shading', 'interp'); colormap(customcolormap);
figure; topoplot(TinCon_aud_LowPer_Hits_meanAmp_LPP_2, ALLEEG.chanlocs, 'maplimits', 'maxmin', 'style', 'both', 'shading', 'interp'); colormap(customcolormap);

Controls_aud_LowPer_Hits_ERP_3chan = Controls_aud_LowPer_Hits_ERP_avg([5 10 15],:);
Tinnitus_aud_LowPer_Hits_ERP_3chan = Tinnitus_aud_LowPer_Hits_ERP_avg([5 10 15],:);

%% Plotting - 75s only

load Controls_aud_75_ERP_ST;
load Tinnitus_aud_75_ERP_ST;

Controls_aud_75_ERP_sub_avg = [];
Tinnitus_aud_75_ERP_sub_avg = [];
Controls_aud_75_ERP_sub_var = [];
Tinnitus_aud_75_ERP_sub_var = [];

for i = 1 : 10
    Controls_aud_75_ERP_sub_avg(:,:,i) = reshape(mean(Controls_aud_75_ERP_ST(i).subject.trial,1),20,900);
    Controls_aud_75_ERP_sub_var(:,:,i) = reshape(var(Controls_aud_75_ERP_ST(i).subject.trial,0,1),20,900);
end

for i = 1 : 11
    Tinnitus_aud_75_ERP_sub_avg(:,:,i) = reshape(mean(Tinnitus_aud_75_ERP_ST(i).subject.trial,1),20,900);
    Tinnitus_aud_75_ERP_sub_var(:,:,i) = reshape(var(Tinnitus_aud_75_ERP_ST(i).subject.trial,0,1),20,900);
end

Controls_aud_75_ERP_avg = mean(Controls_aud_75_ERP_sub_avg,3);
Controls_pooledSD = sqrt(mean(Controls_aud_75_ERP_sub_var,3)./1857);
Controls_aud_75_ERP_pooledSE = Controls_pooledSD.*sqrt(10/1857);

Tinnitus_aud_75_ERP_avg = mean(Tinnitus_aud_75_ERP_sub_avg,3);
Tinnitus_pooledSD = sqrt(mean(Tinnitus_aud_75_ERP_sub_var,3)./1636);
Tinnitus_aud_75_ERP_pooledSE = Tinnitus_pooledSD.*sqrt(11/1636);

Tin_Con_aud_75_ERP_avg = Tinnitus_aud_75_ERP_avg - Controls_aud_75_ERP_avg;

customcolormap = customcolormap_preset('red-white-blue');

% during stimulus potential - 708 - 788

chans_dS = [9 10 11 13 14 15 18];

Controls_aud_75_meanAmp_LPP_2 = mean(Controls_aud_75_ERP_avg(1:19,203:223),2);
Tinnitus_aud_75_meanAmp_LPP_2 = mean(Tinnitus_aud_75_ERP_avg(1:19,203:223),2);

TinCon_aud_75_meanAmp_LPP_2 = Tinnitus_aud_75_meanAmp_LPP_2 - Controls_aud_75_meanAmp_LPP_2;

figure; topoplot(Controls_aud_75_meanAmp_LPP_2, ALLEEG.chanlocs, 'maplimits', 'maxmin', 'style', 'both', 'shading', 'interp'); colormap(customcolormap);
figure; topoplot(Tinnitus_aud_75_meanAmp_LPP_2, ALLEEG.chanlocs, 'maplimits', 'maxmin', 'style', 'both', 'shading', 'interp'); colormap(customcolormap);
figure; topoplot(TinCon_aud_75_meanAmp_LPP_2, ALLEEG.chanlocs, 'maplimits', 'maxmin', 'style', 'both', 'shading', 'interp'); colormap(customcolormap);

Controls_aud_75_ERP_avg_plot_dS = mean(Controls_aud_75_ERP_avg(chans_dS,:),1);
Tinnitus_aud_75_ERP_avg_plot_dS = mean(Tinnitus_aud_75_ERP_avg(chans_dS,:),1);

% post stimulus potential - 1044 - 1200 - duirng noise

chans_dN = [9 10 11 13 14 15];

Controls_aud_75_meanAmp_LPP_3 = mean(Controls_aud_75_ERP_avg(1:19,287:326),2);
Tinnitus_aud_75_meanAmp_LPP_3 = mean(Tinnitus_aud_75_ERP_avg(1:19,287:326),2);

TinCon_aud_75_meanAmp_LPP_3 = Tinnitus_aud_75_meanAmp_LPP_3 - Controls_aud_75_meanAmp_LPP_3;

figure; topoplot(Controls_aud_75_meanAmp_LPP_3, ALLEEG.chanlocs, 'maplimits', 'maxmin', 'style', 'both', 'shading', 'interp'); colormap(customcolormap);
figure; topoplot(Tinnitus_aud_75_meanAmp_LPP_3, ALLEEG.chanlocs, 'maplimits', 'maxmin', 'style', 'both', 'shading', 'interp'); colormap(customcolormap);
figure; topoplot(TinCon_aud_75_meanAmp_LPP_3, ALLEEG.chanlocs, 'maplimits', 'maxmin', 'style', 'both', 'shading', 'interp'); colormap(customcolormap);

Controls_aud_75_ERP_avg_plot_dN = mean(Controls_aud_75_ERP_avg(chans_dN,:),1);
Tinnitus_aud_75_ERP_avg_plot_dN = mean(Tinnitus_aud_75_ERP_avg(chans_dN,:),1);

%post stimulus potential - 1372 - 1456

chans_postS = [3:7];

Controls_aud_75_meanAmp_LPP_4 = mean(Controls_aud_75_ERP_avg(1:19,369:390),2);
Tinnitus_aud_75_meanAmp_LPP_4 = mean(Tinnitus_aud_75_ERP_avg(1:19,369:390),2);

TinCon_aud_75_meanAmp_LPP_4 = Tinnitus_aud_75_meanAmp_LPP_4 - Controls_aud_75_meanAmp_LPP_4;

figure; topoplot(Controls_aud_75_meanAmp_LPP_4, ALLEEG.chanlocs, 'maplimits', 'maxmin', 'style', 'both', 'shading', 'interp'); colormap(customcolormap);
figure; topoplot(Tinnitus_aud_75_meanAmp_LPP_4, ALLEEG.chanlocs, 'maplimits', 'maxmin', 'style', 'both', 'shading', 'interp'); colormap(customcolormap);
figure; topoplot(TinCon_aud_75_meanAmp_LPP_4, ALLEEG.chanlocs, 'maplimits', 'maxmin', 'style', 'both', 'shading', 'interp'); colormap(customcolormap);

Controls_aud_75_ERP_avg_plot_postS = mean(Controls_aud_75_ERP_avg(chans_postS,:),1);
Tinnitus_aud_75_ERP_avg_plot_postS = mean(Tinnitus_aud_75_ERP_avg(chans_postS,:),1);

% pre-stimulus (-200 to 0)

% Controls_aud_75_Miss_meanAmp_prestim = mean(Controls_aud_75_Hits_ERP_avg(1:19,33:101),2);
% Tinnitus_aud_75_Miss_meanAmp_prestim = mean(Tinnitus_aud_75_Hits_ERP_avg(1:19,33:101),2);
% 
% TinCon_aud_75_Miss_meanAmp_prestim = Tinnitus_aud_75_Miss_meanAmp_prestim - Controls_aud_75_Miss_meanAmp_prestim;
% 
% figure; topoplot(Controls_aud_75_Miss_meanAmp_prestim, ALLEEG.chanlocs, 'maplimits', 'maxmin', 'style', 'both', 'shading', 'interp'); colormap(customcolormap);
% figure; topoplot(Tinnitus_aud_75_Miss_meanAmp_prestim, ALLEEG.chanlocs, 'maplimits', 'maxmin', 'style', 'both', 'shading', 'interp'); colormap(customcolormap);
% figure; topoplot(TinCon_aud_75_Miss_meanAmp_prestim, ALLEEG.chanlocs, 'maplimits', 'maxmin', 'style', 'both', 'shading', 'interp'); colormap(customcolormap);

%% High Per: Hits: Controls and Tinnitus Time-frequency 

load('D:\2. Tinnitus Priors ERP\Matlab data_FT\Times_new');
load('D:\2. Tinnitus Priors ERP\Matlab data_FT\frex');

load Controls_aud_HighPer_Hits_ERP_ST;
load Tinnitus_aud_HighPer_Hits_ERP_ST;

Controls_aud_HighPer_Hits_ERP_sub_avg = [];
Tinnitus_aud_HighPer_Hits_ERP_sub_avg = [];

for i = 1 : 4
    Controls_aud_HighPer_Hits_ERP_sub_avg(:,:,i) = reshape(Controls_aud_HighPer_Hits_ERP_ST(i).subject.avg,20,900);
end


for i = 1 : 3
    Tinnitus_aud_HighPer_Hits_ERP_sub_avg(:,:,i) = reshape(Tinnitus_aud_HighPer_Hits_ERP_ST(i).subject.avg,20,900);
end

%Controls

[axm_01_aud_HighPer_Hits_ERP_tf_nobc] = tf_decomp_ERP(Controls_aud_HighPer_Hits_ERP_sub_avg(15,:,1), 1, Times_new);

[jxo_09_aud_HighPer_Hits_ERP_tf_nobc] = tf_decomp_ERP(Controls_aud_HighPer_Hits_ERP_sub_avg(15,:,2), 1, Times_new);

[lxh_22_aud_HighPer_Hits_ERP_tf_nobc] = tf_decomp_ERP(Controls_aud_HighPer_Hits_ERP_sub_avg(15,:,3), 1, Times_new);

[oxh_24_aud_HighPer_Hits_ERP_tf_nobc] = tf_decomp_ERP(Controls_aud_HighPer_Hits_ERP_sub_avg(15,:,4), 1, Times_new);


%Tinnitus

[axl_13_aud_HighPer_Hits_ERP_tf_nobc] = tf_decomp_ERP(Tinnitus_aud_HighPer_Hits_ERP_sub_avg(15,:,1), 1, Times_new);

[lxh_10_aud_HighPer_Hits_ERP_tf_nobc] = tf_decomp_ERP(Tinnitus_aud_HighPer_Hits_ERP_sub_avg(15,:,2), 1, Times_new);

[rxp_02_aud_HighPer_Hits_ERP_tf_nobc] = tf_decomp_ERP(Tinnitus_aud_HighPer_Hits_ERP_sub_avg(15,:,3), 1, Times_new);

Controls_aud_HighPer_Hits_ERP_tf_nobc(:,:,1) = axm_01_aud_HighPer_Hits_ERP_tf_nobc;
Controls_aud_HighPer_Hits_ERP_tf_nobc(:,:,2) = jxo_09_aud_HighPer_Hits_ERP_tf_nobc;
Controls_aud_HighPer_Hits_ERP_tf_nobc(:,:,3) = lxh_22_aud_HighPer_Hits_ERP_tf_nobc;
Controls_aud_HighPer_Hits_ERP_tf_nobc(:,:,4) = oxh_24_aud_HighPer_Hits_ERP_tf_nobc;
save Controls_aud_HighPer_Hits_ERP_tf_nobc Controls_aud_HighPer_Hits_ERP_tf_nobc

Tinnitus_aud_HighPer_Hits_ERP_tf_nobc(:,:,1) = axl_13_aud_HighPer_Hits_ERP_tf_nobc;
Tinnitus_aud_HighPer_Hits_ERP_tf_nobc(:,:,2) = lxh_10_aud_HighPer_Hits_ERP_tf_nobc;
Tinnitus_aud_HighPer_Hits_ERP_tf_nobc(:,:,3) = rxp_02_aud_HighPer_Hits_ERP_tf_nobc;
save Tinnitus_aud_HighPer_Hits_ERP_tf_nobc Tinnitus_aud_HighPer_Hits_ERP_tf_nobc

Controls_aud_HighPer_Hits_ERP_tf_nobc_avg = mean(Controls_aud_HighPer_Hits_ERP_tf_nobc,3);
Tinnitus_aud_HighPer_Hits_ERP_tf_nobc_avg = mean(Tinnitus_aud_HighPer_Hits_ERP_tf_nobc,3);
TinCon_aud_HighPer_Hits_ERP_tf_nobc_avg = Tinnitus_aud_HighPer_Hits_ERP_tf_nobc_avg - Controls_aud_HighPer_Hits_ERP_tf_nobc_avg;

customcolormap = customcolormap_preset('red-white-blue');
figure; contourf(Times_new, frex, Controls_aud_HighPer_Hits_ERP_tf_nobc_avg(:,:),40, 'linecolor', 'none'); colormap(customcolormap);
figure; contourf(Times_new, frex, Tinnitus_aud_HighPer_Hits_ERP_tf_nobc_avg(:,:),40, 'linecolor', 'none'); colormap(customcolormap);
figure; contourf(Times_new, frex, TinCon_aud_HighPer_Hits_ERP_tf_nobc_avg(:,:), 40, 'linecolor', 'none'); colormap(customcolormap);

Controls_Theta_amp = reshape(mean(mean(Controls_aud_HighPer_Hits_ERP_tf_nobc(13:26,197:216,:),1),2),4,1); 
Tinnitus_Theta_amp = reshape(mean(mean(Tinnitus_aud_HighPer_Hits_ERP_tf_nobc(13:26,197:216,:),1),2),3,1);

Controls_Alpha_amp = reshape(mean(mean(Controls_aud_HighPer_Hits_ERP_tf_nobc(29:45,197:216,:),1),2),4,1); 
Tinnitus_Alpha_amp = reshape(mean(mean(Tinnitus_aud_HighPer_Hits_ERP_tf_nobc(29:45,197:216,:),1),2),3,1);

Controls_Beta_amp = reshape(mean(mean(Controls_aud_HighPer_Hits_ERP_tf_nobc(49:117,197:216,:),1),2),4,1); 
Tinnitus_Beta_amp = reshape(mean(mean(Tinnitus_aud_HighPer_Hits_ERP_tf_nobc(49:117,197:216,:),1),2),3,1);

Controls_Gamma_amp = reshape(mean(mean(Controls_aud_HighPer_Hits_ERP_tf_nobc(119:173,197:216,:),1),2),4,1); 
Tinnitus_Gamma_amp = reshape(mean(mean(Tinnitus_aud_HighPer_Hits_ERP_tf_nobc(119:173,197:216,:),1),2),3,1);
...
load Controls_aud_LowPer_Hits_ERP_ST;
load Tinnitus_aud_LowPer_Hits_ERP_ST;

Controls_aud_LowPer_Hits_ERP_sub_avg = [];
Tinnitus_aud_LowPer_Hits_ERP_sub_avg = [];

for i = 1 : 4
    Controls_aud_LowPer_Hits_ERP_sub_avg(:,:,i) = reshape(Controls_aud_LowPer_Hits_ERP_ST(i).subject.avg,20,900);
end


for i = 1 : 5
    Tinnitus_aud_LowPer_Hits_ERP_sub_avg(:,:,i) = reshape(Tinnitus_aud_LowPer_Hits_ERP_ST(i).subject.avg,20,900);
end

%Controls

[jxn_11_aud_LowPer_Hits_ERP_tf_nobc] = tf_decomp_ERP(Controls_aud_LowPer_Hits_ERP_sub_avg(15,:,1), 1, Times_new);

[kxj_15_aud_LowPer_Hits_ERP_tf_nobc] = tf_decomp_ERP(Controls_aud_LowPer_Hits_ERP_sub_avg(15,:,2), 1, Times_new);

[pxm_25_aud_LowPer_Hits_ERP_tf_nobc] = tf_decomp_ERP(Controls_aud_LowPer_Hits_ERP_sub_avg(15,:,3), 1, Times_new);

[rxv_17_aud_LowPer_Hits_ERP_tf_nobc] = tf_decomp_ERP(Controls_aud_LowPer_Hits_ERP_sub_avg(15,:,4), 1, Times_new);


%Tinnitus

[bxr_06_aud_LowPer_Hits_ERP_tf_nobc] = tf_decomp_ERP(Tinnitus_aud_LowPer_Hits_ERP_sub_avg(15,:,1), 1, Times_new);

[evw_07_aud_LowPer_Hits_ERP_tf_nobc] = tf_decomp_ERP(Tinnitus_aud_LowPer_Hits_ERP_sub_avg(15,:,2), 1, Times_new);

[kxj_19_aud_LowPer_Hits_ERP_tf_nobc] = tf_decomp_ERP(Tinnitus_aud_LowPer_Hits_ERP_sub_avg(15,:,3), 1, Times_new);

[pxp_04_aud_LowPer_Hits_ERP_tf_nobc] = tf_decomp_ERP(Tinnitus_aud_LowPer_Hits_ERP_sub_avg(15,:,4), 1, Times_new);

[sxc_08_aud_LowPer_Hits_ERP_tf_nobc] = tf_decomp_ERP(Tinnitus_aud_LowPer_Hits_ERP_sub_avg(15,:,5), 1, Times_new);

Controls_aud_LowPer_Hits_ERP_tf_nobc(:,:,1) = jxn_11_aud_LowPer_Hits_ERP_tf_nobc;
Controls_aud_LowPer_Hits_ERP_tf_nobc(:,:,2) = kxj_15_aud_LowPer_Hits_ERP_tf_nobc;
Controls_aud_LowPer_Hits_ERP_tf_nobc(:,:,3) = pxm_25_aud_LowPer_Hits_ERP_tf_nobc;
Controls_aud_LowPer_Hits_ERP_tf_nobc(:,:,4) = rxv_17_aud_LowPer_Hits_ERP_tf_nobc;
save Controls_aud_LowPer_Hits_ERP_tf_nobc Controls_aud_LowPer_Hits_ERP_tf_nobc

Tinnitus_aud_LowPer_Hits_ERP_tf_nobc(:,:,1) = bxr_06_aud_LowPer_Hits_ERP_tf_nobc;
Tinnitus_aud_LowPer_Hits_ERP_tf_nobc(:,:,2) = evw_07_aud_LowPer_Hits_ERP_tf_nobc;
Tinnitus_aud_LowPer_Hits_ERP_tf_nobc(:,:,3) = kxj_19_aud_LowPer_Hits_ERP_tf_nobc;
Tinnitus_aud_LowPer_Hits_ERP_tf_nobc(:,:,4) = pxp_04_aud_LowPer_Hits_ERP_tf_nobc;
Tinnitus_aud_LowPer_Hits_ERP_tf_nobc(:,:,5) = sxc_08_aud_LowPer_Hits_ERP_tf_nobc;
save Tinnitus_aud_LowPer_Hits_ERP_tf_nobc Tinnitus_aud_LowPer_Hits_ERP_tf_nobc

Controls_aud_LowPer_Hits_ERP_tf_nobc_avg = mean(Controls_aud_LowPer_Hits_ERP_tf_nobc,3);
Tinnitus_aud_LowPer_Hits_ERP_tf_nobc_avg = mean(Tinnitus_aud_LowPer_Hits_ERP_tf_nobc,3);
TinCon_aud_LowPer_Hits_ERP_tf_nobc_avg = Tinnitus_aud_LowPer_Hits_ERP_tf_nobc_avg - Controls_aud_LowPer_Hits_ERP_tf_nobc_avg;

customcolormap = customcolormap_preset('red-white-blue');
figure; contourf(Times_new, frex, Controls_aud_LowPer_Hits_ERP_tf_nobc_avg(:,:),40, 'linecolor', 'none'); colormap(customcolormap);
figure; contourf(Times_new, frex, Tinnitus_aud_LowPer_Hits_ERP_tf_nobc_avg(:,:),40, 'linecolor', 'none'); colormap(customcolormap);
figure; contourf(Times_new, frex, TinCon_aud_LowPer_Hits_ERP_tf_nobc_avg(:,:), 40, 'linecolor', 'none'); colormap(customcolormap);

Controls_Theta_amp = reshape(mean(mean(Controls_aud_LowPer_Hits_ERP_tf_nobc(13:26,215:229,:),1),2),4,1); 
Tinnitus_Theta_amp = reshape(mean(mean(Tinnitus_aud_LowPer_Hits_ERP_tf_nobc(13:26,215:229,:),1),2),5,1);

Controls_Alpha_amp = reshape(mean(mean(Controls_aud_LowPer_Hits_ERP_tf_nobc(29:45,215:229,:),1),2),4,1); 
Tinnitus_Alpha_amp = reshape(mean(mean(Tinnitus_aud_LowPer_Hits_ERP_tf_nobc(29:45,215:229,:),1),2),5,1);

Controls_Beta_amp = reshape(mean(mean(Controls_aud_LowPer_Hits_ERP_tf_nobc(49:117,215:229,:),1),2),4,1); 
Tinnitus_Beta_amp = reshape(mean(mean(Tinnitus_aud_LowPer_Hits_ERP_tf_nobc(49:117,215:229,:),1),2),5,1);

Controls_Gamma_amp = reshape(mean(mean(Controls_aud_LowPer_Hits_ERP_tf_nobc(119:173,215:229,:),1),2),4,1); 
Tinnitus_Gamma_amp = reshape(mean(mean(Tinnitus_aud_LowPer_Hits_ERP_tf_nobc(119:173,215:229,:),1),2),5,1);
