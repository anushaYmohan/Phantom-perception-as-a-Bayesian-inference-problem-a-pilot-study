...
cfg.latency = 'all';
cfg.keeptrials = 'yes';
axm_01_vis_LR_75_ERP_ST = ft_timelockanalysis(cfg, axm_01_vis_LR_75_preproc);
save axm_01_vis_LR_75_ERP_ST axm_01_vis_LR_75_ERP_ST;

%Generation of full ERP
cfg.latency = 'all';
cfg.keeptrials = 'no';
axm_01_vis_LR_75_ERP = ft_timelockanalysis(cfg, axm_01_vis_LR_75_preproc);
save axm_01_vis_LR_75_ERP axm_01_vis_LR_75_ERP;
...
cfg.latency = 'all';
cfg.keeptrials = 'yes';
jvw_16_vis_LR_75_ERP_ST = ft_timelockanalysis(cfg, jvw_16_vis_LR_75_preproc);
save jvw_16_vis_LR_75_ERP_ST jvw_16_vis_LR_75_ERP_ST;

%Generation of full ERP
cfg.latency = 'all';
cfg.keeptrials = 'no';
jvw_16_vis_LR_75_ERP = ft_timelockanalysis(cfg, jvw_16_vis_LR_75_preproc);
save jvw_16_vis_LR_75_ERP jvw_16_vis_LR_75_ERP;
...
cfg.latency = 'all';
cfg.keeptrials = 'yes';
jxn_11_vis_RL_75_ERP_ST = ft_timelockanalysis(cfg, jxn_11_vis_RL_75_preproc);
save jxn_11_vis_RL_75_ERP_ST jxn_11_vis_RL_75_ERP_ST;

%Generation of full ERP
cfg.latency = 'all';
cfg.keeptrials = 'no';
jxn_11_vis_RL_75_ERP = ft_timelockanalysis(cfg, jxn_11_vis_RL_75_preproc);
save jxn_11_vis_RL_75_ERP jxn_11_vis_RL_75_ERP;
...
cfg.latency = 'all';
cfg.keeptrials = 'yes';
jxo_09_vis_RL_75_ERP_ST = ft_timelockanalysis(cfg, jxo_09_vis_RL_75_preproc);
save jxo_09_vis_RL_75_ERP_ST jxo_09_vis_RL_75_ERP_ST;

%Generation of full ERP
cfg.latency = 'all';
cfg.keeptrials = 'no';
jxo_09_vis_RL_75_ERP = ft_timelockanalysis(cfg, jxo_09_vis_RL_75_preproc);
save jxo_09_vis_RL_75_ERP jxo_09_vis_RL_75_ERP;
...
cfg.latency = 'all';
cfg.keeptrials = 'yes';
kxj_15_vis_RL_75_ERP_ST = ft_timelockanalysis(cfg, kxj_15_vis_RL_75_preproc);
save kxj_15_vis_RL_75_ERP_ST kxj_15_vis_RL_75_ERP_ST;

%Generation of full ERP
cfg.latency = 'all';
cfg.keeptrials = 'no';
kxj_15_vis_RL_75_ERP = ft_timelockanalysis(cfg, kxj_15_vis_RL_75_preproc);
save kxj_15_vis_RL_75_ERP kxj_15_vis_RL_75_ERP;
...
cfg.latency = 'all';
cfg.keeptrials = 'yes';
lxh_22_vis_LR_75_ERP_ST = ft_timelockanalysis(cfg, lxh_22_vis_LR_75_preproc);
save lxh_22_vis_LR_75_ERP_ST lxh_22_vis_LR_75_ERP_ST;

%Generation of full ERP
cfg.latency = 'all';
cfg.keeptrials = 'no';
lxh_22_vis_LR_75_ERP = ft_timelockanalysis(cfg, lxh_22_vis_LR_75_preproc);
save lxh_22_vis_LR_75_ERP lxh_22_vis_LR_75_ERP;
...
cfg.latency = 'all';
cfg.keeptrials = 'yes';
lxo_21_vis_LR_75_ERP_ST = ft_timelockanalysis(cfg, lxo_21_vis_LR_75_preproc);
save lxo_21_vis_LR_75_ERP_ST lxo_21_vis_LR_75_ERP_ST;

%Generation of full ERP
cfg.latency = 'all';
cfg.keeptrials = 'no';
lxo_21_vis_LR_75_ERP = ft_timelockanalysis(cfg, lxo_21_vis_LR_75_preproc);
save lxo_21_vis_LR_75_ERP lxo_21_vis_LR_75_ERP;
...
cfg.latency = 'all';
cfg.keeptrials = 'yes';
oxh_24_vis_RL_75_ERP_ST = ft_timelockanalysis(cfg, oxh_24_vis_RL_75_preproc);
save oxh_24_vis_RL_75_ERP_ST oxh_24_vis_RL_75_ERP_ST;

%Generation of full ERP
cfg.latency = 'all';
cfg.keeptrials = 'no';
oxh_24_vis_RL_75_ERP = ft_timelockanalysis(cfg, oxh_24_vis_RL_75_preproc);
save oxh_24_vis_RL_75_ERP oxh_24_vis_RL_75_ERP;
...
cfg.latency = 'all';
cfg.keeptrials = 'yes';
pxm_25_vis_LR_75_ERP_ST = ft_timelockanalysis(cfg, pxm_25_vis_LR_75_preproc);
save pxm_25_vis_LR_75_ERP_ST pxm_25_vis_LR_75_ERP_ST;

%Generation of full ERP
cfg.latency = 'all';
cfg.keeptrials = 'no';
pxm_25_vis_LR_75_ERP = ft_timelockanalysis(cfg, pxm_25_vis_LR_75_preproc);
save pxm_25_vis_LR_75_ERP pxm_25_vis_LR_75_ERP;
...
cfg.latency = 'all';
cfg.keeptrials = 'yes';
rxv_17_vis_RL_75_ERP_ST = ft_timelockanalysis(cfg, rxv_17_vis_RL_75_preproc);
save rxv_17_vis_RL_75_ERP_ST rxv_17_vis_RL_75_ERP_ST;

%Generation of full ERP
cfg.latency = 'all';
cfg.keeptrials = 'no';
rxv_17_vis_RL_75_ERP = ft_timelockanalysis(cfg, rxv_17_vis_RL_75_preproc);
save rxv_17_vis_RL_75_ERP rxv_17_vis_RL_75_ERP;
