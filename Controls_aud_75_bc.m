...
cfg.latency = 'all';
cfg.keeptrials = 'yes';
axm_01_aud_LR_75_ERP_ST_bc = ft_timelockanalysis(cfg, axm_01_aud_LR_75_preproc_bc);
save axm_01_aud_LR_75_ERP_ST_bc axm_01_aud_LR_75_ERP_ST_bc;

%Generation of full ERP
cfg.latency = 'all';
cfg.keeptrials = 'no';
axm_01_aud_LR_75_ERP_bc = ft_timelockanalysis(cfg, axm_01_aud_LR_75_preproc_bc);
save axm_01_aud_LR_75_ERP_bc axm_01_aud_LR_75_ERP_bc;
...
cfg.latency = 'all';
cfg.keeptrials = 'yes';
jvw_16_aud_LR_75_ERP_ST_bc = ft_timelockanalysis(cfg, jvw_16_aud_LR_75_preproc_bc);
save jvw_16_aud_LR_75_ERP_ST_bc jvw_16_aud_LR_75_ERP_ST_bc;

%Generation of full ERP
cfg.latency = 'all';
cfg.keeptrials = 'no';
jvw_16_aud_LR_75_ERP_bc = ft_timelockanalysis(cfg, jvw_16_aud_LR_75_preproc_bc);
save jvw_16_aud_LR_75_ERP_bc jvw_16_aud_LR_75_ERP_bc;
...
cfg.latency = 'all';
cfg.keeptrials = 'yes';
jxn_11_aud_RL_75_ERP_ST_bc = ft_timelockanalysis(cfg, jxn_11_aud_RL_75_preproc_bc);
save jxn_11_aud_RL_75_ERP_ST_bc jxn_11_aud_RL_75_ERP_ST_bc;

%Generation of full ERP
cfg.latency = 'all';
cfg.keeptrials = 'no';
jxn_11_aud_RL_75_ERP_bc = ft_timelockanalysis(cfg, jxn_11_aud_RL_75_preproc_bc);
save jxn_11_aud_RL_75_ERP_bc jxn_11_aud_RL_75_ERP_bc;
...
cfg.latency = 'all';
cfg.keeptrials = 'yes';
jxo_09_aud_RL_75_ERP_ST_bc = ft_timelockanalysis(cfg, jxo_09_aud_RL_75_preproc_bc);
save jxo_09_aud_RL_75_ERP_ST_bc jxo_09_aud_RL_75_ERP_ST_bc;

%Generation of full ERP
cfg.latency = 'all';
cfg.keeptrials = 'no';
jxo_09_aud_RL_75_ERP_bc = ft_timelockanalysis(cfg, jxo_09_aud_RL_75_preproc_bc);
save jxo_09_aud_RL_75_ERP_bc jxo_09_aud_RL_75_ERP_bc;
...
cfg.latency = 'all';
cfg.keeptrials = 'yes';
kxj_15_aud_RL_75_ERP_ST_bc = ft_timelockanalysis(cfg, kxj_15_aud_RL_75_preproc_bc);
save kxj_15_aud_RL_75_ERP_ST_bc kxj_15_aud_RL_75_ERP_ST_bc;

%Generation of full ERP
cfg.latency = 'all';
cfg.keeptrials = 'no';
kxj_15_aud_RL_75_ERP_bc = ft_timelockanalysis(cfg, kxj_15_aud_RL_75_preproc_bc);
save kxj_15_aud_RL_75_ERP_bc kxj_15_aud_RL_75_ERP_bc;
...
cfg.latency = 'all';
cfg.keeptrials = 'yes';
lxh_22_aud_LR_75_ERP_ST_bc = ft_timelockanalysis(cfg, lxh_22_aud_LR_75_preproc_bc);
save lxh_22_aud_LR_75_ERP_ST_bc lxh_22_aud_LR_75_ERP_ST_bc;

%Generation of full ERP
cfg.latency = 'all';
cfg.keeptrials = 'no';
lxh_22_aud_LR_75_ERP_bc = ft_timelockanalysis(cfg, lxh_22_aud_LR_75_preproc_bc);
save lxh_22_aud_LR_75_ERP_bc lxh_22_aud_LR_75_ERP_bc;
...
cfg.latency = 'all';
cfg.keeptrials = 'yes';
lxo_21_aud_LR_75_ERP_ST_bc = ft_timelockanalysis(cfg, lxo_21_aud_LR_75_preproc_bc);
save lxo_21_aud_LR_75_ERP_ST_bc lxo_21_aud_LR_75_ERP_ST_bc;

%Generation of full ERP
cfg.latency = 'all';
cfg.keeptrials = 'no';
lxo_21_aud_LR_75_ERP_bc = ft_timelockanalysis(cfg, lxo_21_aud_LR_75_preproc_bc);
save lxo_21_aud_LR_75_ERP_bc lxo_21_aud_LR_75_ERP_bc;
...
cfg.latency = 'all';
cfg.keeptrials = 'yes';
oxh_24_aud_RL_75_ERP_ST_bc = ft_timelockanalysis(cfg, oxh_24_aud_RL_75_preproc_bc);
save oxh_24_aud_RL_75_ERP_ST_bc oxh_24_aud_RL_75_ERP_ST_bc;

%Generation of full ERP
cfg.latency = 'all';
cfg.keeptrials = 'no';
oxh_24_aud_RL_75_ERP_bc = ft_timelockanalysis(cfg, oxh_24_aud_RL_75_preproc_bc);
save oxh_24_aud_RL_75_ERP_bc oxh_24_aud_RL_75_ERP_bc;
...
cfg.latency = 'all';
cfg.keeptrials = 'yes';
pxm_25_aud_LR_75_ERP_ST_bc = ft_timelockanalysis(cfg, pxm_25_aud_LR_75_preproc_bc);
save pxm_25_aud_LR_75_ERP_ST_bc pxm_25_aud_LR_75_ERP_ST_bc;

%Generation of full ERP
cfg.latency = 'all';
cfg.keeptrials = 'no';
pxm_25_aud_LR_75_ERP_bc = ft_timelockanalysis(cfg, pxm_25_aud_LR_75_preproc_bc);
save pxm_25_aud_LR_75_ERP_bc pxm_25_aud_LR_75_ERP_bc;
...
cfg.latency = 'all';
cfg.keeptrials = 'yes';
rxv_17_aud_RL_75_ERP_ST_bc = ft_timelockanalysis(cfg, rxv_17_aud_RL_75_preproc_bc);
save rxv_17_aud_RL_75_ERP_ST_bc rxv_17_aud_RL_75_ERP_ST_bc;

%Generation of full ERP
cfg.latency = 'all';
cfg.keeptrials = 'no';
rxv_17_aud_RL_75_ERP_bc = ft_timelockanalysis(cfg, rxv_17_aud_RL_75_preproc_bc);
save rxv_17_aud_RL_75_ERP_bc rxv_17_aud_RL_75_ERP_bc;
