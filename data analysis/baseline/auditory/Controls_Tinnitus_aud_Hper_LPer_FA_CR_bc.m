...
%% Plotting: High Perceivers : FA: Tinnitus vs Controls 

load Controls_aud_HighPer_FA_ERP_ST_bc;
load Tinnitus_aud_HighPer_FA_ERP_ST_bc;
load('D:\2. Tinnitus Priors ERP\Matlab data_FT\Times_new.mat');

Controls_aud_HighPer_FA_ERP_sub_avg = [];
Tinnitus_aud_HighPer_FA_ERP_sub_avg = [];
Controls_aud_HighPer_FA_ERP_sub_var = [];
Tinnitus_aud_HighPer_FA_ERP_sub_var = [];


for i = 1 : 4
    Controls_aud_HighPer_FA_ERP_sub_avg(:,:,i) = reshape(Controls_aud_HighPer_FA_ERP_ST_bc(i).subject.avg,20,900);
    %Controls_aud_HighPer_FA_ERP_sub_var(:,:,i) = reshape(var(Controls_aud_10_CR_ERP_ST_bc(Controls_sub(i)).subject.trial,0,1),20,900);
end


for i = 1 : 3
    Tinnitus_aud_HighPer_FA_ERP_sub_avg(:,:,i) = reshape(Tinnitus_aud_HighPer_FA_ERP_ST_bc(i).subject.avg,20,900);
    %Tinnitus_aud_HighPer_FA_ERP_sub_var(:,:,i) = reshape(var(Tinnitus_aud_10_CR_ERP_ST_bc(Tinnitus_sub(i)).subject.trial,0,1),20,900);
end

Controls_aud_HighPer_FA_ERP_avg = mean(Controls_aud_HighPer_FA_ERP_sub_avg,3);
Controls_pooledSD = sqrt(mean(Controls_aud_HighPer_FA_ERP_sub_var,3)./1857);
Controls_aud_HighPer_FA_ERP_pooledSE = Controls_pooledSD.*sqrt(4/1857);

Tinnitus_aud_HighPer_FA_ERP_avg = mean(Tinnitus_aud_HighPer_FA_ERP_sub_avg,3);
Tinnitus_pooledSD = sqrt(mean(Tinnitus_aud_HighPer_FA_ERP_sub_var,3)./1636);
Tinnitus_aud_HighPer_FA_ERP_pooledSE = Tinnitus_pooledSD.*sqrt(4/1636);

Tin_Con_aud_HighPer_FA_ERP_avg = Tinnitus_aud_HighPer_FA_ERP_avg - Controls_aud_HighPer_FA_ERP_avg;

customcolormap = customcolormap_preset('red-white-blue');

% during stimulus potential - 684 - 760

Controls_aud_HighPer_FA_meanAmp_LPP_2 = mean(Controls_aud_HighPer_FA_ERP_avg(1:19,197:216),2);
Tinnitus_aud_HighPer_FA_meanAmp_LPP_2 = mean(Tinnitus_aud_HighPer_FA_ERP_avg(1:19,197:216),2);
...
Controls_aud_HighPer_FA_ERP_3chan = Controls_aud_HighPer_FA_ERP_avg([5 10 15],:);
Tinnitus_aud_HighPer_FA_ERP_3chan = Tinnitus_aud_HighPer_FA_ERP_avg([5 10 15],:);
%% Plotting: Low Perceivers : CR: Tinnitus vs Controls 

load Controls_aud_LowPer_CR_ERP_ST_bc;
load Tinnitus_aud_LowPer_CR_ERP_ST_bc;
load('D:\2. Tinnitus Priors ERP\Matlab data_FT\Times_new.mat');

Controls_aud_LowPer_CR_ERP_sub_avg = [];
Tinnitus_aud_LowPer_CR_ERP_sub_avg = [];
%Controls_aud_LowPer_CR_ERP_sub_var = [];
%Tinnitus_aud_LowPer_CR_ERP_sub_var = [];


for i = 1 : 4
    Controls_aud_LowPer_CR_ERP_sub_avg(:,:,i) = reshape(Controls_aud_LowPer_CR_ERP_ST_bc(i).subject.avg,20,900);
    %Controls_aud_LowPer_CR_ERP_sub_var(:,:,i) = reshape(var(Controls_aud_10_CR_ERP_ST_bc(Controls_sub(i)).subject.trial,0,1),20,900);
end


for i = 1 : 5
    Tinnitus_aud_LowPer_CR_ERP_sub_avg(:,:,i) = reshape(Tinnitus_aud_LowPer_CR_ERP_ST_bc(i).subject.avg,20,900);
    %Tinnitus_aud_LowPer_CR_ERP_sub_var(:,:,i) = reshape(var(Tinnitus_aud_10_CR_ERP_ST_bc(Tinnitus_sub(i)).subject.trial,0,1),20,900);
end

Controls_aud_LowPer_CR_ERP_avg = mean(Controls_aud_LowPer_CR_ERP_sub_avg,3);
%Controls_pooledSD = sqrt(mean(Controls_aud_LowPer_CR_ERP_sub_var,3)./1857);
%Controls_aud_LowPer_CR_ERP_pooledSE = Controls_pooledSD.*sqrt(4/1857);

Tinnitus_aud_LowPer_CR_ERP_avg = mean(Tinnitus_aud_LowPer_CR_ERP_sub_avg,3);
%Tinnitus_pooledSD = sqrt(mean(Tinnitus_aud_LowPer_CR_ERP_sub_var,3)./1636);
%Tinnitus_aud_LowPer_CR_ERP_pooledSE = Tinnitus_pooledSD.*sqrt(4/1636);

Tin_Con_aud_LowPer_CR_ERP_avg = Tinnitus_aud_LowPer_CR_ERP_avg - Controls_aud_LowPer_CR_ERP_avg;

customcolormap = customcolormap_preset('red-white-blue');

% post stimulus potential - 1852 - 2000

Controls_aud_LowPer_CR_meanAmp_LPP_2 = mean(Controls_aud_LowPer_CR_ERP_avg(1:19,489:526),2);
Tinnitus_aud_LowPer_CR_meanAmp_LPP_2 = mean(Tinnitus_aud_LowPer_CR_ERP_avg(1:19,489:526),2);

TinCon_aud_LowPer_CR_meanAmp_LPP_2 = Tinnitus_aud_LowPer_CR_meanAmp_LPP_2 - Controls_aud_LowPer_CR_meanAmp_LPP_2;

figure; topoplot(Controls_aud_LowPer_CR_meanAmp_LPP_2, ALLEEG.chanlocs, 'maplimits', 'maxmin', 'style', 'both', 'shading', 'interp'); colormap(customcolormap);
figure; topoplot(Tinnitus_aud_LowPer_CR_meanAmp_LPP_2, ALLEEG.chanlocs, 'maplimits', 'maxmin', 'style', 'both', 'shading', 'interp'); colormap(customcolormap);
figure; topoplot(TinCon_aud_LowPer_CR_meanAmp_LPP_2, ALLEEG.chanlocs, 'maplimits', 'maxmin', 'style', 'both', 'shading', 'interp'); colormap(customcolormap);

Controls_aud_LowPer_CR_ERP_3chan = Controls_aud_LowPer_CR_ERP_avg([5 10 15],:);
Tinnitus_aud_LowPer_CR_ERP_3chan = Tinnitus_aud_LowPer_CR_ERP_avg([5 10 15],:);
...
load Controls_aud_HighPer_FA_ERP_ST;
load Tinnitus_aud_HighPer_FA_ERP_ST;

Controls_aud_HighPer_FA_ERP_sub_avg = [];
Tinnitus_aud_HighPer_FA_ERP_sub_avg = [];

for i = 1 : 4
    Controls_aud_HighPer_FA_ERP_sub_avg(:,:,i) = reshape(Controls_aud_HighPer_FA_ERP_ST(i).subject.avg,20,900);
end


for i = 1 : 3
    Tinnitus_aud_HighPer_FA_ERP_sub_avg(:,:,i) = reshape(Tinnitus_aud_HighPer_FA_ERP_ST(i).subject.avg,20,900);
end

%Controls

[axm_01_aud_HighPer_FA_ERP_tf_nobc] = tf_decomp_ERP(Controls_aud_HighPer_FA_ERP_sub_avg(15,:,1), 1, Times_new);

[jxo_09_aud_HighPer_FA_ERP_tf_nobc] = tf_decomp_ERP(Controls_aud_HighPer_FA_ERP_sub_avg(15,:,2), 1, Times_new);

[lxh_22_aud_HighPer_FA_ERP_tf_nobc] = tf_decomp_ERP(Controls_aud_HighPer_FA_ERP_sub_avg(15,:,3), 1, Times_new);

[oxh_24_aud_HighPer_FA_ERP_tf_nobc] = tf_decomp_ERP(Controls_aud_HighPer_FA_ERP_sub_avg(15,:,4), 1, Times_new);


%Tinnitus

[axl_13_aud_HighPer_FA_ERP_tf_nobc] = tf_decomp_ERP(Tinnitus_aud_HighPer_FA_ERP_sub_avg(15,:,1), 1, Times_new);

[lxh_10_aud_HighPer_FA_ERP_tf_nobc] = tf_decomp_ERP(Tinnitus_aud_HighPer_FA_ERP_sub_avg(15,:,2), 1, Times_new);

[rxp_02_aud_HighPer_FA_ERP_tf_nobc] = tf_decomp_ERP(Tinnitus_aud_HighPer_FA_ERP_sub_avg(15,:,3), 1, Times_new);

Controls_aud_HighPer_FA_ERP_tf_nobc(:,:,1) = axm_01_aud_HighPer_FA_ERP_tf_nobc;
Controls_aud_HighPer_FA_ERP_tf_nobc(:,:,2) = jxo_09_aud_HighPer_FA_ERP_tf_nobc;
Controls_aud_HighPer_FA_ERP_tf_nobc(:,:,3) = lxh_22_aud_HighPer_FA_ERP_tf_nobc;
Controls_aud_HighPer_FA_ERP_tf_nobc(:,:,4) = oxh_24_aud_HighPer_FA_ERP_tf_nobc;
save Controls_aud_HighPer_FA_ERP_tf_nobc Controls_aud_HighPer_FA_ERP_tf_nobc

Tinnitus_aud_HighPer_FA_ERP_tf_nobc(:,:,1) = axl_13_aud_HighPer_FA_ERP_tf_nobc;
Tinnitus_aud_HighPer_FA_ERP_tf_nobc(:,:,2) = lxh_10_aud_HighPer_FA_ERP_tf_nobc;
Tinnitus_aud_HighPer_FA_ERP_tf_nobc(:,:,3) = rxp_02_aud_HighPer_FA_ERP_tf_nobc;
save Tinnitus_aud_HighPer_FA_ERP_tf_nobc Tinnitus_aud_HighPer_FA_ERP_tf_nobc

Controls_aud_HighPer_FA_ERP_tf_nobc_avg = mean(Controls_aud_HighPer_FA_ERP_tf_nobc,3);
Tinnitus_aud_HighPer_FA_ERP_tf_nobc_avg = mean(Tinnitus_aud_HighPer_FA_ERP_tf_nobc,3);
TinCon_aud_HighPer_FA_ERP_tf_nobc_avg = Tinnitus_aud_HighPer_FA_ERP_tf_nobc_avg - Controls_aud_HighPer_FA_ERP_tf_nobc_avg;

customcolormap = customcolormap_preset('red-white-blue');
figure; contourf(Times_new, frex, Controls_aud_HighPer_FA_ERP_tf_nobc_avg(:,:),40, 'linecolor', 'none'); colormap(customcolormap);
figure; contourf(Times_new, frex, Tinnitus_aud_HighPer_FA_ERP_tf_nobc_avg(:,:),40, 'linecolor', 'none'); colormap(customcolormap);
figure; contourf(Times_new, frex, TinCon_aud_HighPer_FA_ERP_tf_nobc_avg(:,:), 40, 'linecolor', 'none'); colormap(customcolormap);

Controls_Theta_amp = reshape(mean(mean(Controls_aud_HighPer_FA_ERP_tf_nobc(13:26,197:216,:),1),2),4,1); 
Tinnitus_Theta_amp = reshape(mean(mean(Tinnitus_aud_HighPer_FA_ERP_tf_nobc(13:26,197:216,:),1),2),3,1);

Controls_Alpha_amp = reshape(mean(mean(Controls_aud_HighPer_FA_ERP_tf_nobc(29:45,197:216,:),1),2),4,1); 
Tinnitus_Alpha_amp = reshape(mean(mean(Tinnitus_aud_HighPer_FA_ERP_tf_nobc(29:45,197:216,:),1),2),3,1);

Controls_Beta_amp = reshape(mean(mean(Controls_aud_HighPer_FA_ERP_tf_nobc(49:117,197:216,:),1),2),4,1); 
Tinnitus_Beta_amp = reshape(mean(mean(Tinnitus_aud_HighPer_FA_ERP_tf_nobc(49:117,197:216,:),1),2),3,1);

Controls_Gamma_amp = reshape(mean(mean(Controls_aud_HighPer_FA_ERP_tf_nobc(119:173,197:216,:),1),2),4,1); 
Tinnitus_Gamma_amp = reshape(mean(mean(Tinnitus_aud_HighPer_FA_ERP_tf_nobc(119:173,197:216,:),1),2),3,1);
...
load Controls_aud_LowPer_CR_ERP_ST;
load Tinnitus_aud_LowPer_CR_ERP_ST;

Controls_aud_LowPer_CR_ERP_sub_avg = [];
Tinnitus_aud_LowPer_CR_ERP_sub_avg = [];

for i = 1 : 4
    Controls_aud_LowPer_CR_ERP_sub_avg(:,:,i) = reshape(Controls_aud_LowPer_CR_ERP_ST(i).subject.avg,20,900);
end


for i = 1 : 5
    Tinnitus_aud_LowPer_CR_ERP_sub_avg(:,:,i) = reshape(Tinnitus_aud_LowPer_CR_ERP_ST(i).subject.avg,20,900);
end

%Controls

[jxn_11_aud_LowPer_CR_ERP_tf_nobc] = tf_decomp_ERP(Controls_aud_LowPer_CR_ERP_sub_avg(15,:,1), 1, Times_new);

[kxj_15_aud_LowPer_CR_ERP_tf_nobc] = tf_decomp_ERP(Controls_aud_LowPer_CR_ERP_sub_avg(15,:,2), 1, Times_new);

[pxm_25_aud_LowPer_CR_ERP_tf_nobc] = tf_decomp_ERP(Controls_aud_LowPer_CR_ERP_sub_avg(15,:,3), 1, Times_new);

[rxv_17_aud_LowPer_CR_ERP_tf_nobc] = tf_decomp_ERP(Controls_aud_LowPer_CR_ERP_sub_avg(15,:,4), 1, Times_new);


%Tinnitus

[bxr_06_aud_LowPer_CR_ERP_tf_nobc] = tf_decomp_ERP(Tinnitus_aud_LowPer_CR_ERP_sub_avg(15,:,1), 1, Times_new);

[evw_07_aud_LowPer_CR_ERP_tf_nobc] = tf_decomp_ERP(Tinnitus_aud_LowPer_CR_ERP_sub_avg(15,:,2), 1, Times_new);

[kxj_19_aud_LowPer_CR_ERP_tf_nobc] = tf_decomp_ERP(Tinnitus_aud_LowPer_CR_ERP_sub_avg(15,:,3), 1, Times_new);

[pxp_04_aud_LowPer_CR_ERP_tf_nobc] = tf_decomp_ERP(Tinnitus_aud_LowPer_CR_ERP_sub_avg(15,:,4), 1, Times_new);

[sxc_08_aud_LowPer_CR_ERP_tf_nobc] = tf_decomp_ERP(Tinnitus_aud_LowPer_CR_ERP_sub_avg(15,:,5), 1, Times_new);

Controls_aud_LowPer_CR_ERP_tf_nobc(:,:,1) = jxn_11_aud_LowPer_CR_ERP_tf_nobc;
Controls_aud_LowPer_CR_ERP_tf_nobc(:,:,2) = kxj_15_aud_LowPer_CR_ERP_tf_nobc;
Controls_aud_LowPer_CR_ERP_tf_nobc(:,:,3) = pxm_25_aud_LowPer_CR_ERP_tf_nobc;
Controls_aud_LowPer_CR_ERP_tf_nobc(:,:,4) = rxv_17_aud_LowPer_CR_ERP_tf_nobc;
save Controls_aud_LowPer_CR_ERP_tf_nobc Controls_aud_LowPer_CR_ERP_tf_nobc

Tinnitus_aud_LowPer_CR_ERP_tf_nobc(:,:,1) = bxr_06_aud_LowPer_CR_ERP_tf_nobc;
Tinnitus_aud_LowPer_CR_ERP_tf_nobc(:,:,2) = evw_07_aud_LowPer_CR_ERP_tf_nobc;
Tinnitus_aud_LowPer_CR_ERP_tf_nobc(:,:,3) = kxj_19_aud_LowPer_CR_ERP_tf_nobc;
Tinnitus_aud_LowPer_CR_ERP_tf_nobc(:,:,4) = pxp_04_aud_LowPer_CR_ERP_tf_nobc;
Tinnitus_aud_LowPer_CR_ERP_tf_nobc(:,:,5) = sxc_08_aud_LowPer_CR_ERP_tf_nobc;
save Tinnitus_aud_LowPer_CR_ERP_tf_nobc Tinnitus_aud_LowPer_CR_ERP_tf_nobc

Controls_aud_LowPer_CR_ERP_tf_nobc_avg = mean(Controls_aud_LowPer_CR_ERP_tf_nobc,3);
Tinnitus_aud_LowPer_CR_ERP_tf_nobc_avg = mean(Tinnitus_aud_LowPer_CR_ERP_tf_nobc,3);
TinCon_aud_LowPer_CR_ERP_tf_nobc_avg = Tinnitus_aud_LowPer_CR_ERP_tf_nobc_avg - Controls_aud_LowPer_CR_ERP_tf_nobc_avg;

customcolormap = customcolormap_preset('red-white-blue');
figure; contourf(Times_new, frex, Controls_aud_LowPer_CR_ERP_tf_nobc_avg(:,:),40, 'linecolor', 'none'); colormap(customcolormap);
figure; contourf(Times_new, frex, Tinnitus_aud_LowPer_CR_ERP_tf_nobc_avg(:,:),40, 'linecolor', 'none'); colormap(customcolormap);
figure; contourf(Times_new, frex, TinCon_aud_LowPer_CR_ERP_tf_nobc_avg(:,:), 40, 'linecolor', 'none'); colormap(customcolormap);

Controls_Theta_amp = reshape(mean(mean(Controls_aud_LowPer_CR_ERP_tf_nobc(13:26,489:526,:),1),2),4,1); 
Tinnitus_Theta_amp = reshape(mean(mean(Tinnitus_aud_LowPer_CR_ERP_tf_nobc(13:26,489:526,:),1),2),5,1);

Controls_Alpha_amp = reshape(mean(mean(Controls_aud_LowPer_CR_ERP_tf_nobc(29:45,489:526,:),1),2),4,1); 
Tinnitus_Alpha_amp = reshape(mean(mean(Tinnitus_aud_LowPer_CR_ERP_tf_nobc(29:45,489:526,:),1),2),5,1);

Controls_Beta_amp = reshape(mean(mean(Controls_aud_LowPer_CR_ERP_tf_nobc(49:117,489:526,:),1),2),4,1); 
Tinnitus_Beta_amp = reshape(mean(mean(Tinnitus_aud_LowPer_CR_ERP_tf_nobc(49:117,489:526,:),1),2),5,1);

Controls_Gamma_amp = reshape(mean(mean(Controls_aud_LowPer_CR_ERP_tf_nobc(119:173,489:526,:),1),2),4,1); 
Tinnitus_Gamma_amp = reshape(mean(mean(Tinnitus_aud_LowPer_CR_ERP_tf_nobc(119:173,489:526,:),1),2),5,1);
