...
addpath('D:\2. Tinnitus Priors ERP\Matlab data_FT\Vis_75_bc\Controls');
addpath('D:\2. Tinnitus Priors ERP\Matlab data_FT\Vis_75_bc\Tinnitus');

load('D:\2. Tinnitus Priors ERP\Matlab data_FT\Times_new.mat');
load('D:\2. Tinnitus Priors ERP\Matlab data_FT\Channels_Ft.mat');

load('axm_01_vis_LR_75_ERP_ST_bc.mat');
load('jvw_16_vis_LR_75_ERP_ST_bc.mat');
load('jxo_09_vis_RL_75_ERP_ST_bc.mat');
load('jxn_11_vis_RL_75_ERP_ST_bc.mat');
load('kxj_15_vis_RL_75_ERP_ST_bc.mat');
load('lxh_22_vis_LR_75_ERP_ST_bc.mat');
load('lxo_21_vis_LR_75_ERP_ST_bc.mat');
load('oxh_24_vis_RL_75_ERP_ST_bc.mat');
load('pxm_25_vis_LR_75_ERP_ST_bc.mat');
load('rxv_17_vis_RL_75_ERP_ST_bc.mat');


load('axl_13_vis_RL_75_ERP_ST_bc.mat');
load('bxr_06_vis_LR_75_ERP_ST_bc.mat');
load('evw_07_vis_RL_75_ERP_ST_bc.mat');
load('ivl_14_vis_LR_75_ERP_ST_bc.mat');
load('ixe_12_vis_LR_75_ERP_ST_bc.mat');
load('jvj_18_vis_LR_75_ERP_ST_bc.mat');
load('kxj_19_vis_RL_75_ERP_ST_bc.mat');
load('lxh_10_vis_LR_75_ERP_ST_bc.mat');
load('pxp_04_vis_LR_75_ERP_ST_bc.mat');
load('rxp_02_vis_RL_75_ERP_ST_bc.mat');
load('sxc_08_vis_RL_75_ERP_ST_bc.mat');

% Building new variables - Controls

axm_01_vis_75_Hits_ERP_ST_bc =[];
jvw_16_vis_75_Hits_ERP_ST_bc =[];
jxo_09_vis_75_Hits_ERP_ST_bc =[];
jxn_11_vis_75_Hits_ERP_ST_bc =[];
kxj_15_vis_75_Hits_ERP_ST_bc =[];
lxh_22_vis_75_Hits_ERP_ST_bc =[];
lxo_21_vis_75_Hits_ERP_ST_bc =[];
oxh_24_vis_75_Hits_ERP_ST_bc =[];
pxm_25_vis_75_Hits_ERP_ST_bc =[];
rxv_17_vis_75_Hits_ERP_ST_bc =[];


% axm_01
disp('axm_01');
data = axm_01_vis_LR_75_ERP_ST_bc.trial;
size_data = size(data);
...
axm_01_vis_75_Hits_ERP_ST_bc.SubID = 'axm_01';
axm_01_vis_75_Hits_ERP_ST_bc.time = axm_01_vis_LR_75_ERP_ST_bc.time;
axm_01_vis_75_Hits_ERP_ST_bc.label = Channels_Ft.label;
axm_01_vis_75_Hits_ERP_ST_bc.elec = Channels_Ft;
axm_01_vis_75_Hits_ERP_ST_bc.trial = axm_01_epochs_75_Hits;
axm_01_vis_75_Hits_ERP_ST_bc.avg = mean(axm_01_epochs_75_Hits,1);
axm_01_vis_75_Hits_ERP_ST_bc.dimord = 'rpt_chan_time';
axm_01_vis_75_Hits_ERP_ST_bc.cfg = axm_01_vis_LR_75_ERP_ST_bc.cfg;

% jvw_16
disp('jvw_16');
data = jvw_16_vis_LR_75_ERP_ST_bc.trial;
size_data = size(data);
num_events = size_data(1);
...
jvw_16_vis_75_Hits_ERP_ST_bc.SubID = 'jvw_16';
jvw_16_vis_75_Hits_ERP_ST_bc.time = jvw_16_vis_LR_75_ERP_ST_bc.time;
jvw_16_vis_75_Hits_ERP_ST_bc.label = Channels_Ft.label;
jvw_16_vis_75_Hits_ERP_ST_bc.elec = Channels_Ft;
jvw_16_vis_75_Hits_ERP_ST_bc.trial = jvw_16_epochs_75_Hits;
jvw_16_vis_75_Hits_ERP_ST_bc.avg = mean(jvw_16_epochs_75_Hits,1);
jvw_16_vis_75_Hits_ERP_ST_bc.dimord = 'rpt_chan_time';
jvw_16_vis_75_Hits_ERP_ST_bc.cfg = jvw_16_vis_LR_75_ERP_ST_bc.cfg;


% jxn_11
disp('jxn_11');
data = jxn_11_vis_RL_75_ERP_ST_bc.trial;
size_data = size(data);
num_events = size_data(1);
...
jxn_11_vis_75_Hits_ERP_ST_bc.SubID = 'jxn_11';
jxn_11_vis_75_Hits_ERP_ST_bc.time = jxn_11_vis_RL_75_ERP_ST_bc.time;
jxn_11_vis_75_Hits_ERP_ST_bc.label = Channels_Ft.label;
jxn_11_vis_75_Hits_ERP_ST_bc.elec = Channels_Ft;
jxn_11_vis_75_Hits_ERP_ST_bc.trial = jxn_11_epochs_75_Hits;
jxn_11_vis_75_Hits_ERP_ST_bc.avg = mean(jxn_11_epochs_75_Hits,1);
jxn_11_vis_75_Hits_ERP_ST_bc.dimord = 'rpt_chan_time';
jxn_11_vis_75_Hits_ERP_ST_bc.cfg = jxn_11_vis_RL_75_ERP_ST_bc.cfg;

% jxo_09
disp('jxo_09');
data = jxo_09_vis_RL_75_ERP_ST_bc.trial;
size_data = size(data);
num_events = size_data(1);
...
jxo_09_vis_75_Hits_ERP_ST_bc.SubID = 'jxo_09';
jxo_09_vis_75_Hits_ERP_ST_bc.time = jxo_09_vis_RL_75_ERP_ST_bc.time;
jxo_09_vis_75_Hits_ERP_ST_bc.label = Channels_Ft.label;
jxo_09_vis_75_Hits_ERP_ST_bc.elec = Channels_Ft;
jxo_09_vis_75_Hits_ERP_ST_bc.trial = jxo_09_epochs_75_Hits;
jxo_09_vis_75_Hits_ERP_ST_bc.avg = mean(jxo_09_epochs_75_Hits,1);
jxo_09_vis_75_Hits_ERP_ST_bc.dimord = 'rpt_chan_time';
jxo_09_vis_75_Hits_ERP_ST_bc.cfg = jxo_09_vis_RL_75_ERP_ST_bc.cfg;

% kxj_15
disp('kxj_15');
data = kxj_15_vis_RL_75_ERP_ST_bc.trial;
size_data = size(data);
num_events = size_data(1);
...
kxj_15_vis_75_Hits_ERP_ST_bc.SubID = 'kxj_15';
kxj_15_vis_75_Hits_ERP_ST_bc.time = kxj_15_vis_RL_75_ERP_ST_bc.time;
kxj_15_vis_75_Hits_ERP_ST_bc.label = Channels_Ft.label;
kxj_15_vis_75_Hits_ERP_ST_bc.elec = Channels_Ft;
kxj_15_vis_75_Hits_ERP_ST_bc.trial = kxj_15_epochs_75_Hits;
kxj_15_vis_75_Hits_ERP_ST_bc.avg = mean(kxj_15_epochs_75_Hits,1);
kxj_15_vis_75_Hits_ERP_ST_bc.dimord = 'rpt_chan_time';
kxj_15_vis_75_Hits_ERP_ST_bc.cfg = kxj_15_vis_RL_75_ERP_ST_bc.cfg;

% lxh_22
disp('lxh_22');
data = lxh_22_vis_LR_75_ERP_ST_bc.trial;
size_data = size(data);
num_events = size_data(1);
...
lxh_22_vis_75_Hits_ERP_ST_bc.SubID = 'lxh_22';
lxh_22_vis_75_Hits_ERP_ST_bc.time = lxh_22_vis_LR_75_ERP_ST_bc.time;
lxh_22_vis_75_Hits_ERP_ST_bc.label = Channels_Ft.label;
lxh_22_vis_75_Hits_ERP_ST_bc.elec = Channels_Ft;
lxh_22_vis_75_Hits_ERP_ST_bc.trial = lxh_22_epochs_75_Hits;
lxh_22_vis_75_Hits_ERP_ST_bc.avg = mean(lxh_22_epochs_75_Hits,1);
lxh_22_vis_75_Hits_ERP_ST_bc.dimord = 'rpt_chan_time';
lxh_22_vis_75_Hits_ERP_ST_bc.cfg = lxh_22_vis_LR_75_ERP_ST_bc.cfg;

% lxo_21
disp('lxo_21');
data = lxo_21_vis_LR_75_ERP_ST_bc.trial;
size_data = size(data);
num_events = size_data(1);
...
lxo_21_vis_75_Hits_ERP_ST_bc.SubID = 'lxo_21';
lxo_21_vis_75_Hits_ERP_ST_bc.time = lxo_21_vis_LR_75_ERP_ST_bc.time;
lxo_21_vis_75_Hits_ERP_ST_bc.label = Channels_Ft.label;
lxo_21_vis_75_Hits_ERP_ST_bc.elec = Channels_Ft;
lxo_21_vis_75_Hits_ERP_ST_bc.trial = lxo_21_epochs_75_Hits;
lxo_21_vis_75_Hits_ERP_ST_bc.avg = mean(lxo_21_epochs_75_Hits,1);
lxo_21_vis_75_Hits_ERP_ST_bc.dimord = 'rpt_chan_time';
lxo_21_vis_75_Hits_ERP_ST_bc.cfg = lxo_21_vis_LR_75_ERP_ST_bc.cfg;

% oxh_24
disp('oxh_24');
data = oxh_24_vis_RL_75_ERP_ST_bc.trial;
size_data = size(data);
num_events = size_data(1);
...
oxh_24_vis_75_Hits_ERP_ST_bc.SubID = 'oxh_24';
oxh_24_vis_75_Hits_ERP_ST_bc.time = oxh_24_vis_RL_75_ERP_ST_bc.time;
oxh_24_vis_75_Hits_ERP_ST_bc.label = Channels_Ft.label;
oxh_24_vis_75_Hits_ERP_ST_bc.elec = Channels_Ft;
oxh_24_vis_75_Hits_ERP_ST_bc.trial = oxh_24_epochs_75_Hits;
oxh_24_vis_75_Hits_ERP_ST_bc.avg = mean(oxh_24_epochs_75_Hits,1);
oxh_24_vis_75_Hits_ERP_ST_bc.dimord = 'rpt_chan_time';
oxh_24_vis_75_Hits_ERP_ST_bc.cfg = oxh_24_vis_RL_75_ERP_ST_bc.cfg;

% pxm_25
disp('pxm_25');
data = pxm_25_vis_LR_75_ERP_ST_bc.trial;
size_data = size(data);
num_events = size_data(1);
...
pxm_25_vis_75_Hits_ERP_ST_bc.SubID = 'pxm_25';
pxm_25_vis_75_Hits_ERP_ST_bc.time = pxm_25_vis_LR_75_ERP_ST_bc.time;
pxm_25_vis_75_Hits_ERP_ST_bc.label = Channels_Ft.label;
pxm_25_vis_75_Hits_ERP_ST_bc.elec = Channels_Ft;
pxm_25_vis_75_Hits_ERP_ST_bc.trial = pxm_25_epochs_75_Hits;
pxm_25_vis_75_Hits_ERP_ST_bc.avg = mean(pxm_25_epochs_75_Hits,1);
pxm_25_vis_75_Hits_ERP_ST_bc.dimord = 'rpt_chan_time';
pxm_25_vis_75_Hits_ERP_ST_bc.cfg = pxm_25_vis_LR_75_ERP_ST_bc.cfg;

% rxv_17
disp('rxv_17');
data = rxv_17_vis_RL_75_ERP_ST_bc.trial;
size_data = size(data);
num_events = size_data(1);
...
rxv_17_vis_75_Hits_ERP_ST_bc.SubID = 'rxv_17';
rxv_17_vis_75_Hits_ERP_ST_bc.time = rxv_17_vis_RL_75_ERP_ST_bc.time;
rxv_17_vis_75_Hits_ERP_ST_bc.label = Channels_Ft.label;
rxv_17_vis_75_Hits_ERP_ST_bc.elec = Channels_Ft;
rxv_17_vis_75_Hits_ERP_ST_bc.trial = rxv_17_epochs_75_Hits;
rxv_17_vis_75_Hits_ERP_ST_bc.avg = mean(rxv_17_epochs_75_Hits,1);
rxv_17_vis_75_Hits_ERP_ST_bc.dimord = 'rpt_chan_time';
rxv_17_vis_75_Hits_ERP_ST_bc.cfg = rxv_17_vis_RL_75_ERP_ST_bc.cfg;

Controls_vis_75_Hits_ERP_ST_bc(1).subject = axm_01_vis_75_Hits_ERP_ST_bc;
Controls_vis_75_Hits_ERP_ST_bc(2).subject = jvw_16_vis_75_Hits_ERP_ST_bc;
Controls_vis_75_Hits_ERP_ST_bc(3).subject = jxn_11_vis_75_Hits_ERP_ST_bc;
Controls_vis_75_Hits_ERP_ST_bc(4).subject = jxo_09_vis_75_Hits_ERP_ST_bc;
Controls_vis_75_Hits_ERP_ST_bc(5).subject = kxj_15_vis_75_Hits_ERP_ST_bc;
Controls_vis_75_Hits_ERP_ST_bc(6).subject = lxh_22_vis_75_Hits_ERP_ST_bc;
Controls_vis_75_Hits_ERP_ST_bc(7).subject = lxo_21_vis_75_Hits_ERP_ST_bc;
Controls_vis_75_Hits_ERP_ST_bc(8).subject = oxh_24_vis_75_Hits_ERP_ST_bc;
Controls_vis_75_Hits_ERP_ST_bc(9).subject = pxm_25_vis_75_Hits_ERP_ST_bc;
Controls_vis_75_Hits_ERP_ST_bc(10).subject = rxv_17_vis_75_Hits_ERP_ST_bc;

save Controls_vis_75_Hits_ERP_ST_bc Controls_vis_75_Hits_ERP_ST_bc;

Controls_vis_HighPer_Hits_ERP_ST_bc(1).subject = jxo_09_vis_75_Hits_ERP_ST_bc;
Controls_vis_HighPer_Hits_ERP_ST_bc(2).subject = lxh_22_vis_75_Hits_ERP_ST_bc;
Controls_vis_HighPer_Hits_ERP_ST_bc(3).subject = oxh_24_vis_75_Hits_ERP_ST_bc;
Controls_vis_HighPer_Hits_ERP_ST_bc(4).subject = pxm_25_vis_75_Hits_ERP_ST_bc;

Controls_vis_LowPer_Hits_ERP_ST_bc(1).subject = axm_01_vis_75_Hits_ERP_ST_bc;
Controls_vis_LowPer_Hits_ERP_ST_bc(2).subject = jvw_16_vis_75_Hits_ERP_ST_bc;
Controls_vis_LowPer_Hits_ERP_ST_bc(3).subject = jxn_11_vis_75_Hits_ERP_ST_bc;
Controls_vis_LowPer_Hits_ERP_ST_bc(4).subject = kxj_15_vis_75_Hits_ERP_ST_bc;
Controls_vis_LowPer_Hits_ERP_ST_bc(5).subject = rxv_17_vis_75_Hits_ERP_ST_bc;

save Controls_vis_HighPer_Hits_ERP_ST_bc Controls_vis_HighPer_Hits_ERP_ST_bc;
save Controls_vis_LowPer_Hits_ERP_ST_bc Controls_vis_LowPer_Hits_ERP_ST_bc;
...
clear axm_01_vis_LR_75_HitsERP_ST_bc ;
clear jvw_16_vis_LR_75_HitsERP_ST_bc ;
clear jxo_09_vis_RL_75_HitsERP_ST_bc ;
clear jxn_11_vis_RL_75_HitsERP_ST_bc ;
clear kxj_15_vis_RL_75_HitsERP_ST_bc ;
clear lxh_22_vis_LR_75_HitsERP_ST_bc ;
clear lxo_21_vis_LR_75_HitsERP_ST_bc ;
clear oxh_24_vis_RL_75_HitsERP_ST_bc ;
clear pxm_25_vis_LR_75_HitsERP_ST_bc ;
clear rxv_17_vis_RL_75_HitsERP_ST_bc ;

% Building new variables  - Tinnitus 

axl_13_vis_75_Hits_ERP_ST_bc =[];
bxr_06_vis_75_Hits_ERP_ST_bc =[];
evw_07_vis_75_Hits_ERP_ST_bc =[];
ivl_14_vis_75_Hits_ERP_ST_bc =[];
ixe_12_vis_75_Hits_ERP_ST_bc =[];
jvj_18_vis_75_Hits_ERP_ST_bc =[];
kxj_19_vis_75_Hits_ERP_ST_bc =[];
lxh_10_vis_75_Hits_ERP_ST_bc =[];
pxp_04_vis_75_Hits_ERP_ST_bc =[];
rxp_02_vis_75_Hits_ERP_ST_bc =[];
sxc_08_vis_75_Hits_ERP_ST_bc =[];

% axl_13
disp('axl_13');
data = axl_13_vis_RL_75_ERP_ST_bc.trial;
size_data = size(data);
num_events = size_data(1);
...
axl_13_vis_75_Hits_ERP_ST_bc.SubID = 'axl_13';
axl_13_vis_75_Hits_ERP_ST_bc.time = axl_13_vis_RL_75_ERP_ST_bc.time;
axl_13_vis_75_Hits_ERP_ST_bc.label = Channels_Ft.label;
axl_13_vis_75_Hits_ERP_ST_bc.elec = Channels_Ft;
axl_13_vis_75_Hits_ERP_ST_bc.trial = axl_13_epochs_75_Hits;
axl_13_vis_75_Hits_ERP_ST_bc.avg = mean(axl_13_epochs_75_Hits,1);
axl_13_vis_75_Hits_ERP_ST_bc.dimord = 'rpt_chan_time';
axl_13_vis_75_Hits_ERP_ST_bc.cfg = axl_13_vis_RL_75_ERP_ST_bc.cfg;

% bxr_06
data = bxr_06_vis_LR_75_ERP_ST_bc.trial;
size_data = size(data);
num_events = size_data(1);
...
bxr_06_vis_75_Hits_ERP_ST_bc.SubID = 'bxr_06';
bxr_06_vis_75_Hits_ERP_ST_bc.time = bxr_06_vis_LR_75_ERP_ST_bc.time;
bxr_06_vis_75_Hits_ERP_ST_bc.label = Channels_Ft.label;
bxr_06_vis_75_Hits_ERP_ST_bc.elec = Channels_Ft;
bxr_06_vis_75_Hits_ERP_ST_bc.trial = bxr_06_epochs_75_Hits;
bxr_06_vis_75_Hits_ERP_ST_bc.avg = mean(bxr_06_epochs_75_Hits,1);
bxr_06_vis_75_Hits_ERP_ST_bc.dimord = 'rpt_chan_time';
bxr_06_vis_75_Hits_ERP_ST_bc.cfg = bxr_06_vis_LR_75_ERP_ST_bc.cfg;

% evw_07
disp('evw_07');
data = evw_07_vis_RL_75_ERP_ST_bc.trial;
size_data = size(data);
num_events = size_data(1);
...
evw_07_vis_75_Hits_ERP_ST_bc.SubID = 'evw_07';
evw_07_vis_75_Hits_ERP_ST_bc.time = evw_07_vis_RL_75_ERP_ST_bc.time;
evw_07_vis_75_Hits_ERP_ST_bc.label = Channels_Ft.label;
evw_07_vis_75_Hits_ERP_ST_bc.elec = Channels_Ft;
evw_07_vis_75_Hits_ERP_ST_bc.trial = evw_07_epochs_75_Hits;
evw_07_vis_75_Hits_ERP_ST_bc.avg = mean(evw_07_epochs_75_Hits,1);
evw_07_vis_75_Hits_ERP_ST_bc.dimord = 'rpt_chan_time';
evw_07_vis_75_Hits_ERP_ST_bc.cfg = evw_07_vis_RL_75_ERP_ST_bc.cfg;

% ivl_14
disp('ivl_14');
data = ivl_14_vis_LR_75_ERP_ST_bc.trial;
size_data = size(data);
num_events = size_data(1);
...
ivl_14_vis_75_Hits_ERP_ST_bc.SubID = 'ivl_14';
ivl_14_vis_75_Hits_ERP_ST_bc.time = ivl_14_vis_LR_75_ERP_ST_bc.time;
ivl_14_vis_75_Hits_ERP_ST_bc.label = Channels_Ft.label;
ivl_14_vis_75_Hits_ERP_ST_bc.elec = Channels_Ft;
ivl_14_vis_75_Hits_ERP_ST_bc.trial = ivl_14_epochs_75_Hits;
ivl_14_vis_75_Hits_ERP_ST_bc.avg = mean(ivl_14_epochs_75_Hits,1);
ivl_14_vis_75_Hits_ERP_ST_bc.dimord = 'rpt_chan_time';
ivl_14_vis_75_Hits_ERP_ST_bc.cfg = ivl_14_vis_LR_75_ERP_ST_bc.cfg;

% ixe_12
disp('ixe_12');
data = ixe_12_vis_LR_75_ERP_ST_bc.trial;
size_data = size(data);
num_events = size_data(1);
...
ixe_12_vis_75_Hits_ERP_ST_bc.SubID = 'ixe_12';
ixe_12_vis_75_Hits_ERP_ST_bc.time = ixe_12_vis_LR_75_ERP_ST_bc.time;
ixe_12_vis_75_Hits_ERP_ST_bc.label = Channels_Ft.label;
ixe_12_vis_75_Hits_ERP_ST_bc.elec = Channels_Ft;
ixe_12_vis_75_Hits_ERP_ST_bc.trial = ixe_12_epochs_75_Hits;
ixe_12_vis_75_Hits_ERP_ST_bc.avg = mean(ixe_12_epochs_75_Hits,1);
ixe_12_vis_75_Hits_ERP_ST_bc.dimord = 'rpt_chan_time';
ixe_12_vis_75_Hits_ERP_ST_bc.cfg = ixe_12_vis_LR_75_ERP_ST_bc.cfg;

% jvj_18
disp('jvj_18');
data = jvj_18_vis_LR_75_ERP_ST_bc.trial;
size_data = size(data);
num_events = size_data(1);
...
jvj_18_vis_75_Hits_ERP_ST_bc.SubID = 'jvj_18';
jvj_18_vis_75_Hits_ERP_ST_bc.time = jvj_18_vis_LR_75_ERP_ST_bc.time;
jvj_18_vis_75_Hits_ERP_ST_bc.label = Channels_Ft.label;
jvj_18_vis_75_Hits_ERP_ST_bc.elec = Channels_Ft;
jvj_18_vis_75_Hits_ERP_ST_bc.trial = jvj_18_epochs_75_Hits;
jvj_18_vis_75_Hits_ERP_ST_bc.avg = mean(jvj_18_epochs_75_Hits,1);
jvj_18_vis_75_Hits_ERP_ST_bc.dimord = 'rpt_chan_time';
jvj_18_vis_75_Hits_ERP_ST_bc.cfg = jvj_18_vis_LR_75_ERP_ST_bc.cfg;

% kxj_19
disp('kxj_19');
data = kxj_19_vis_RL_75_ERP_ST_bc.trial;
size_data = size(data);
num_events = size_data(1);
...
kxj_19_vis_75_Hits_ERP_ST_bc.SubID = 'kxj_19';
kxj_19_vis_75_Hits_ERP_ST_bc.time = kxj_19_vis_RL_75_ERP_ST_bc.time;
kxj_19_vis_75_Hits_ERP_ST_bc.label = Channels_Ft.label;
kxj_19_vis_75_Hits_ERP_ST_bc.elec = Channels_Ft;
kxj_19_vis_75_Hits_ERP_ST_bc.trial = kxj_19_epochs_75_Hits;
kxj_19_vis_75_Hits_ERP_ST_bc.avg = mean(kxj_19_epochs_75_Hits,1);
kxj_19_vis_75_Hits_ERP_ST_bc.dimord = 'rpt_chan_time';
kxj_19_vis_75_Hits_ERP_ST_bc.cfg = kxj_19_vis_RL_75_ERP_ST_bc.cfg;

% lxh_10
disp('lxh_10');
data = lxh_10_vis_LR_75_ERP_ST_bc.trial;
size_data = size(data);
num_events = size_data(1);
...
lxh_10_vis_75_Hits_ERP_ST_bc.SubID = 'lxh_10';
lxh_10_vis_75_Hits_ERP_ST_bc.time = lxh_10_vis_LR_75_ERP_ST_bc.time;
lxh_10_vis_75_Hits_ERP_ST_bc.label = Channels_Ft.label;
lxh_10_vis_75_Hits_ERP_ST_bc.elec = Channels_Ft;
lxh_10_vis_75_Hits_ERP_ST_bc.trial = lxh_10_epochs_75_Hits;
lxh_10_vis_75_Hits_ERP_ST_bc.avg = mean(lxh_10_epochs_75_Hits,1);
lxh_10_vis_75_Hits_ERP_ST_bc.dimord = 'rpt_chan_time';
lxh_10_vis_75_Hits_ERP_ST_bc.cfg = lxh_10_vis_LR_75_ERP_ST_bc.cfg;

% pxp_04
disp('pxp_04');
data = pxp_04_vis_LR_75_ERP_ST_bc.trial;
size_data = size(data);
num_events = size_data(1);
...
pxp_04_vis_75_Hits_ERP_ST_bc.SubID = 'pxp_04';
pxp_04_vis_75_Hits_ERP_ST_bc.time = pxp_04_vis_LR_75_ERP_ST_bc.time;
pxp_04_vis_75_Hits_ERP_ST_bc.label = Channels_Ft.label;
pxp_04_vis_75_Hits_ERP_ST_bc.elec = Channels_Ft;
pxp_04_vis_75_Hits_ERP_ST_bc.trial = pxp_04_epochs_75_Hits;
pxp_04_vis_75_Hits_ERP_ST_bc.avg = mean(pxp_04_epochs_75_Hits,1);
pxp_04_vis_75_Hits_ERP_ST_bc.dimord = 'rpt_chan_time';
pxp_04_vis_75_Hits_ERP_ST_bc.cfg = pxp_04_vis_LR_75_ERP_ST_bc.cfg;

% rxp_02
disp('rxp_02');
data = rxp_02_vis_RL_75_ERP_ST_bc.trial;
size_data = size(data);
num_events = size_data(1);
...
rxp_02_vis_75_Hits_ERP_ST_bc.SubID = 'rxp_02';
rxp_02_vis_75_Hits_ERP_ST_bc.time = rxp_02_vis_RL_75_ERP_ST_bc.time;
rxp_02_vis_75_Hits_ERP_ST_bc.label = Channels_Ft.label;
rxp_02_vis_75_Hits_ERP_ST_bc.elec = Channels_Ft;
rxp_02_vis_75_Hits_ERP_ST_bc.trial = rxp_02_epochs_75_Hits;
rxp_02_vis_75_Hits_ERP_ST_bc.avg = mean(rxp_02_epochs_75_Hits,1);
rxp_02_vis_75_Hits_ERP_ST_bc.dimord = 'rpt_chan_time';
rxp_02_vis_75_Hits_ERP_ST_bc.cfg = rxp_02_vis_RL_75_ERP_ST_bc.cfg;

% sxc_08
disp('sxc_08');
data = sxc_08_vis_RL_75_ERP_ST_bc.trial;
size_data = size(data);
num_events = size_data(1);
...
sxc_08_vis_75_Hits_ERP_ST_bc.SubID = 'sxc_08';
sxc_08_vis_75_Hits_ERP_ST_bc.time = sxc_08_vis_RL_75_ERP_ST_bc.time;
sxc_08_vis_75_Hits_ERP_ST_bc.label = Channels_Ft.label;
sxc_08_vis_75_Hits_ERP_ST_bc.elec = Channels_Ft;
sxc_08_vis_75_Hits_ERP_ST_bc.trial = sxc_08_epochs_75_Hits;
sxc_08_vis_75_Hits_ERP_ST_bc.avg = mean(sxc_08_epochs_75_Hits,1);
sxc_08_vis_75_Hits_ERP_ST_bc.dimord = 'rpt_chan_time';
sxc_08_vis_75_Hits_ERP_ST_bc.cfg = sxc_08_vis_RL_75_ERP_ST_bc.cfg;

Tinnitus_vis_75_Hits_ERP_ST_bc(1).subject = axl_13_vis_75_Hits_ERP_ST_bc;
Tinnitus_vis_75_Hits_ERP_ST_bc(2).subject = bxr_06_vis_75_Hits_ERP_ST_bc;
Tinnitus_vis_75_Hits_ERP_ST_bc(3).subject = evw_07_vis_75_Hits_ERP_ST_bc;
Tinnitus_vis_75_Hits_ERP_ST_bc(4).subject = ivl_14_vis_75_Hits_ERP_ST_bc;
Tinnitus_vis_75_Hits_ERP_ST_bc(5).subject = ixe_12_vis_75_Hits_ERP_ST_bc;
Tinnitus_vis_75_Hits_ERP_ST_bc(6).subject = jvj_18_vis_75_Hits_ERP_ST_bc;
Tinnitus_vis_75_Hits_ERP_ST_bc(7).subject = kxj_19_vis_75_Hits_ERP_ST_bc;
Tinnitus_vis_75_Hits_ERP_ST_bc(8).subject = lxh_10_vis_75_Hits_ERP_ST_bc;
Tinnitus_vis_75_Hits_ERP_ST_bc(9).subject = pxp_04_vis_75_Hits_ERP_ST_bc;
Tinnitus_vis_75_Hits_ERP_ST_bc(10).subject = rxp_02_vis_75_Hits_ERP_ST_bc;
Tinnitus_vis_75_Hits_ERP_ST_bc(11).subject = sxc_08_vis_75_Hits_ERP_ST_bc;

save Tinnitus_vis_75_Hits_ERP_ST_bc Tinnitus_vis_75_Hits_ERP_ST_bc;

Tinnitus_vis_HighPer_Hits_ERP_ST_bc(1).subject = axl_13_vis_75_Hits_ERP_ST_bc;
Tinnitus_vis_HighPer_Hits_ERP_ST_bc(2).subject = jvj_18_vis_75_Hits_ERP_ST_bc;
Tinnitus_vis_HighPer_Hits_ERP_ST_bc(3).subject = kxj_19_vis_75_Hits_ERP_ST_bc;
Tinnitus_vis_HighPer_Hits_ERP_ST_bc(4).subject = lxh_10_vis_75_Hits_ERP_ST_bc;
Tinnitus_vis_HighPer_Hits_ERP_ST_bc(5).subject = rxp_02_vis_75_Hits_ERP_ST_bc;
Tinnitus_vis_HighPer_Hits_ERP_ST_bc(6).subject = sxc_08_vis_75_Hits_ERP_ST_bc;

Tinnitus_vis_LowPer_Hits_ERP_ST_bc(1).subject = bxr_06_vis_75_Hits_ERP_ST_bc;
Tinnitus_vis_LowPer_Hits_ERP_ST_bc(2).subject = evw_07_vis_75_Hits_ERP_ST_bc;
Tinnitus_vis_LowPer_Hits_ERP_ST_bc(3).subject = ivl_14_vis_75_Hits_ERP_ST_bc;
Tinnitus_vis_LowPer_Hits_ERP_ST_bc(4).subject = ixe_12_vis_75_Hits_ERP_ST_bc;
Tinnitus_vis_LowPer_Hits_ERP_ST_bc(5).subject = pxp_04_vis_75_Hits_ERP_ST_bc;

save Tinnitus_vis_HighPer_Hits_ERP_ST_bc Tinnitus_vis_HighPer_Hits_ERP_ST_bc;
save Tinnitus_vis_LowPer_Hits_ERP_ST_bc Tinnitus_vis_LowPer_Hits_ERP_ST_bc;
...
clear axl_13_vis_75_Hits_ERP_ST_bc;
clear bxr_06_vis_75_Hits_ERP_ST_bc;
clear evw_07_vis_75_Hits_ERP_ST_bc;
clear ivl_14_vis_75_Miss_ERP_ST_bc;
clear ixe_12_vis_75_Miss_ERP_ST_bc;
clear jvj_18_vis_75_Miss_ERP_ST_bc;
clear kxj_19_vis_75_Hits_ERP_ST_bc;
clear lxh_10_vis_75_Hits_ERP_ST_bc;
clear pxp_04_vis_75_Hits_ERP_ST_bc;
clear rxp_02_vis_75_Hits_ERP_ST_bc;
clear sxc_08_vis_75_Hits_ERP_ST_bc;

%% All 75 stimuli:
Controls_vis_75_ERP_ST_bc(1).subject = axm_01_vis_LR_75_ERP_ST_bc;
Controls_vis_75_ERP_ST_bc(2).subject = jvw_16_vis_LR_75_ERP_ST_bc;
Controls_vis_75_ERP_ST_bc(3).subject = jxn_11_vis_RL_75_ERP_ST_bc;
Controls_vis_75_ERP_ST_bc(4).subject = jxo_09_vis_RL_75_ERP_ST_bc;
Controls_vis_75_ERP_ST_bc(5).subject = kxj_15_vis_RL_75_ERP_ST_bc;
Controls_vis_75_ERP_ST_bc(6).subject = lxh_22_vis_LR_75_ERP_ST_bc;
Controls_vis_75_ERP_ST_bc(7).subject = lxo_21_vis_LR_75_ERP_ST_bc;
Controls_vis_75_ERP_ST_bc(8).subject = oxh_24_vis_RL_75_ERP_ST_bc;
Controls_vis_75_ERP_ST_bc(9).subject = pxm_25_vis_LR_75_ERP_ST_bc;
Controls_vis_75_ERP_ST_bc(10).subject = rxv_17_vis_RL_75_ERP_ST_bc;

Tinnitus_vis_75_ERP_ST_bc(1).subject = axl_13_vis_RL_75_ERP_ST_bc;
Tinnitus_vis_75_ERP_ST_bc(2).subject = bxr_06_vis_LR_75_ERP_ST_bc;
Tinnitus_vis_75_ERP_ST_bc(3).subject = evw_07_vis_RL_75_ERP_ST_bc;
Tinnitus_vis_75_ERP_ST_bc(4).subject = ivl_14_vis_LR_75_ERP_ST_bc;
Tinnitus_vis_75_ERP_ST_bc(5).subject = ixe_12_vis_LR_75_ERP_ST_bc;
Tinnitus_vis_75_ERP_ST_bc(6).subject = jvj_18_vis_LR_75_ERP_ST_bc;
Tinnitus_vis_75_ERP_ST_bc(7).subject = kxj_19_vis_RL_75_ERP_ST_bc;
Tinnitus_vis_75_ERP_ST_bc(8).subject = lxh_10_vis_LR_75_ERP_ST_bc;
Tinnitus_vis_75_ERP_ST_bc(9).subject = pxp_04_vis_LR_75_ERP_ST_bc;
Tinnitus_vis_75_ERP_ST_bc(10).subject = rxp_02_vis_RL_75_ERP_ST_bc;
Tinnitus_vis_75_ERP_ST_bc(11).subject = sxc_08_vis_RL_75_ERP_ST_bc;

save Controls_vis_75_ERP_ST_bc Controls_vis_75_ERP_ST_bc;
save Tinnitus_vis_75_ERP_ST_bc Tinnitus_vis_75_ERP_ST_bc;

%% stats - High perceivers: Tinnitus vs Controls
restoredefaultpath;
addpath('C:\Users\mohan\OneDrive\Documents\MATLAB\fieldtrip-20230118');
ft_defaults;
load('Controls_vis_HighPer_Hits_ERP_ST_bc.mat');
load('Tinnitus_vis_HighPer_Hits_ERP_ST_bc.mat');
...
[stat_TinCon_vis_HighPer_Hits_ERP_bc] = ft_timelockstatistics(cfg, Tinnitus_vis_HighPer_Hits_ERP_ST_bc(1).subject, Tinnitus_vis_HighPer_Hits_ERP_ST_bc(2).subject, Tinnitus_vis_HighPer_Hits_ERP_ST_bc(3).subject,...
    Tinnitus_vis_HighPer_Hits_ERP_ST_bc(4).subject, Tinnitus_vis_HighPer_Hits_ERP_ST_bc(5).subject, Tinnitus_vis_HighPer_Hits_ERP_ST_bc(6).subject, Controls_vis_HighPer_Hits_ERP_ST_bc(1).subject,...
    Controls_vis_HighPer_Hits_ERP_ST_bc(2).subject, Controls_vis_HighPer_Hits_ERP_ST_bc(3).subject, Controls_vis_HighPer_Hits_ERP_ST_bc(4).subject);
   
stat_logic = [];
for i = 1 : 3
    for j = 1 : 526
        if stat_TinCon_vis_HighPer_Hits_ERP_bc.prob(i,j) < .05
            stat_logic(i,j) = 1;
        else
            stat_logic(i,j) = 0;
        end
...
save stat_TinCon_vis_HighPer_Hits_ERP_bc stat_TinCon_vis_HighPer_Hits_ERP_bc;

%% stats - Low perceivers: Controls vs Tinnitus
restoredefaultpath;
addpath('C:\Users\mohan\OneDrive\Documents\MATLAB\fieldtrip-20230118');
ft_defaults;
load('Controls_vis_LowPer_Hits_ERP_ST_bc.mat');
load('Tinnitus_vis_LowPer_Hits_ERP_ST_bc.mat');
load('D:\2. Tinnitus Priors ERP\Matlab data_FT\neighbours_mitsar.mat');
...
[stat_TinCon_vis_LowPer_Hits_ERP_bc] = ft_timelockstatistics(cfg, Tinnitus_vis_LowPer_Hits_ERP_ST_bc(1).subject, Tinnitus_vis_LowPer_Hits_ERP_ST_bc(2).subject, Tinnitus_vis_LowPer_Hits_ERP_ST_bc(3).subject,...
   Tinnitus_vis_LowPer_Hits_ERP_ST_bc(4).subject, Tinnitus_vis_LowPer_Hits_ERP_ST_bc(5).subject, Controls_vis_LowPer_Hits_ERP_ST_bc(1).subject, Controls_vis_LowPer_Hits_ERP_ST_bc(2).subject, ...
   Controls_vis_LowPer_Hits_ERP_ST_bc(3).subject, Controls_vis_LowPer_Hits_ERP_ST_bc(4).subject, Controls_vis_LowPer_Hits_ERP_ST_bc(5).subject);
   
stat_logic = [];
for i = 1 : 3
    for j = 1 : 526
        if stat_TinCon_vis_LowPer_Hits_ERP_bc.prob(i,j) < .05
            stat_logic(i,j) = 1;
        else
            stat_logic(i,j) = 0;
        end
...
save stat_TinCon_vis_LowPer_Hits_ERP_bc stat_TinCon_vis_LowPer_Hits_ERP_bc;
...
ft_defaults;
load('Controls_vis_75_ERP_ST_bc.mat');
load('Tinnitus_vis_75_ERP_ST_bc.mat');
...
%cfg.avgoverchan = 'yes';
cfg.method = 'montecarlo';
cfg.statistic = 'ft_ST_bcatfun_indepsamplesT';
...
size_Con = size(Controls_vis_75_ERP_ST_bc(1).subject.trial,1) + size(Controls_vis_75_ERP_ST_bc(2).subject.trial,1) + size(Controls_vis_75_ERP_ST_bc(3).subject.trial,1) + size(Controls_vis_75_ERP_ST_bc(4).subject.trial,1) +...
    size(Controls_vis_75_ERP_ST_bc(5).subject.trial,1) + size(Controls_vis_75_ERP_ST_bc(6).subject.trial,1) + size(Controls_vis_75_ERP_ST_bc(7).subject.trial,1) + size(Controls_vis_75_ERP_ST_bc(8).subject.trial,1) + ...
    size(Controls_vis_75_ERP_ST_bc(9).subject.trial,1) + size(Controls_vis_75_ERP_ST_bc(10).subject.trial,1);

size_Tin = size(Tinnitus_vis_75_ERP_ST_bc(1).subject.trial,1) + size(Tinnitus_vis_75_ERP_ST_bc(2).subject.trial,1) + size(Tinnitus_vis_75_ERP_ST_bc(3).subject.trial,1) + size(Tinnitus_vis_75_ERP_ST_bc(4).subject.trial,1) +...
    size(Tinnitus_vis_75_ERP_ST_bc(5).subject.trial,1) + size(Tinnitus_vis_75_ERP_ST_bc(6).subject.trial,1) + size(Tinnitus_vis_75_ERP_ST_bc(7).subject.trial,1) + size(Tinnitus_vis_75_ERP_ST_bc(8).subject.trial,1) + ...
    size(Tinnitus_vis_75_ERP_ST_bc(9).subject.trial,1) + size(Tinnitus_vis_75_ERP_ST_bc(10).subject.trial,1) + size(Tinnitus_vis_75_ERP_ST_bc(11).subject.trial,1);
...
[stat_TinCon_vis_75_ERP_postStim] = ft_timelockstatistics(cfg, Tinnitus_vis_75_ERP_ST_bc(1).subject, Tinnitus_vis_75_ERP_ST_bc(2).subject, Tinnitus_vis_75_ERP_ST_bc(3).subject,...
    Tinnitus_vis_75_ERP_ST_bc(4).subject, Tinnitus_vis_75_ERP_ST_bc(5).subject, Tinnitus_vis_75_ERP_ST_bc(6).subject, Tinnitus_vis_75_ERP_ST_bc(7).subject, Tinnitus_vis_75_ERP_ST_bc(8).subject,...
    Tinnitus_vis_75_ERP_ST_bc(9).subject, Tinnitus_vis_75_ERP_ST_bc(10).subject, Tinnitus_vis_75_ERP_ST_bc(11).subject, Controls_vis_75_ERP_ST_bc(1).subject, Controls_vis_75_ERP_ST_bc(2).subject, ...
    Controls_vis_75_ERP_ST_bc(3).subject, Controls_vis_75_ERP_ST_bc(4).subject, Controls_vis_75_ERP_ST_bc(5).subject, Controls_vis_75_ERP_ST_bc(6).subject, Controls_vis_75_ERP_ST_bc(7).subject,...
    Controls_vis_75_ERP_ST_bc(8).subject, Controls_vis_75_ERP_ST_bc(9).subject, Controls_vis_75_ERP_ST_bc(10).subject);
...
load Controls_vis_HighPer_Hits_ERP_ST_bc;
load Tinnitus_vis_HighPer_Hits_ERP_ST_bc;
...
for i = 1 : 4
    Controls_vis_HighPer_Hits_ERP_sub_avg(:,:,i) = reshape(Controls_vis_HighPer_Hits_ERP_ST_bc(i).subject.avg,20,900);
    %Controls_vis_HighPer_Hits_ERP_sub_var(:,:,i) = reshape(var(Controls_vis_10_CR_ERP_ST_bc(Controls_sub(i)).subject.trial,0,1),20,900);
end


for i = 1 : 6
    Tinnitus_vis_HighPer_Hits_ERP_sub_avg(:,:,i) = reshape(Tinnitus_vis_HighPer_Hits_ERP_ST_bc(i).subject.avg,20,900);
    %Tinnitus_vis_HighPer_Hits_ERP_sub_var(:,:,i) = reshape(var(Tinnitus_vis_10_CR_ERP_ST_bc(Tinnitus_sub(i)).subject.trial,0,1),20,900);
end
...
load Controls_vis_LowPer_Hits_ERP_ST_bc;
load Tinnitus_vis_LowPer_Hits_ERP_ST_bc;
...
for i = 1 : 5
    Controls_vis_LowPer_Hits_ERP_sub_avg(:,:,i) = reshape(Controls_vis_LowPer_Hits_ERP_ST_bc(i).subject.avg,20,900);
    %Controls_vis_LowPer_Hits_ERP_sub_var(:,:,i) = reshape(var(Controls_vis_10_CR_ERP_ST_bc(Controls_sub(i)).subject.trial,0,1),20,900);
end


for i = 1 : 5
    Tinnitus_vis_LowPer_Hits_ERP_sub_avg(:,:,i) = reshape(Tinnitus_vis_LowPer_Hits_ERP_ST_bc(i).subject.avg,20,900);
    %Tinnitus_vis_LowPer_Hits_ERP_sub_var(:,:,i) = reshape(var(Tinnitus_vis_10_CR_ERP_ST_bc(Tinnitus_sub(i)).subject.trial,0,1),20,900);
end
