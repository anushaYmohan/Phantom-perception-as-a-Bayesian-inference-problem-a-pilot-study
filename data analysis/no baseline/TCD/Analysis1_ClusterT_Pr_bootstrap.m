...
pnames_Pr  = {'sdt_001', 'aat_002', 'cas_003', 'eaw_006', 'nis_007', 'cud_008',...
           'eos_012', 'chy_017', 'cry_018', 'taa_019', 'cas_020', 'dit_029',...
...
for isub = 1:length(sublists)
    ...
    elseif find(strcmp(nplists_Pr,sublists{isub}))
        load(strcat(inputpath,sublists{isub},'\',subnames{isub},'_',conditions{2},'_preproc_ERP_ST.mat'));
...
save(strcat(outputpath,'ClusterT_Pr_',filename,'_Bootstrap_pmap'),'pmap');
save(strcat(outputpath,'ClusterT_Pr_',filename,'_Bootstrap_Tstat_map'),'Tstat_map');
