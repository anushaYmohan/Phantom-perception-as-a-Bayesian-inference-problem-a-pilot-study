...
for i = 1 : 4
    ...
    %Controls_aud_HighPer_Hits_ERP_sub_var(:,:,i) = reshape(var(Controls_aud_10_CR_ERP_ST(Controls_sub(i)).subject.trial,0,1),20,900);
end


for i = 1 : 3
    Tinnitus_aud_HighPer_Hits_ERP_sub_avg(:,:,i) = reshape(Tinnitus_aud_HighPer_Hits_ERP_ST(i).subject.avg,20,900);
    %Tinnitus_aud_HighPer_Hits_ERP_sub_var(:,:,i) = reshape(var(Tinnitus_aud_10_CR_ERP_ST(Tinnitus_sub(i)).subject.trial,0,1),20,900);
end
...
for i = 1 : 4
    ...
    %Controls_aud_LowPer_Hits_ERP_sub_var(:,:,i) = reshape(Controls_aud_LowPer_Hits_ERP_ST(i).subject.avg,20,900);
end

for i = 1 : 5
    Tinnitus_aud_LowPer_Hits_ERP_sub_avg(:,:,i) = reshape(Tinnitus_aud_LowPer_Hits_ERP_ST(i).subject.avg,20,900);
    %Tinnitus_aud_LowPer_Hits_ERP_sub_var(:,:,i) = reshape(Controls_aud_LowPer_Hits_ERP_ST(i).subject.avg,20,900);
end
